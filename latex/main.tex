...
\hypersetup{
	% bookmarks,
	pdftitle={Tese}
	,pdfauthor={Gonçalo Silva Pereira - 2009111643}
...
\definecolor{myGreen}{RGB}{0,134,62}
\newcommand*{\green}{\textcolor{myGreen}}
...
% \rhead{Evaluate the robustness of the Cloud}
...
% comments
% \usepackage[author={Gonçalo Pereira}]{pdfcomment}
