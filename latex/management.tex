...
As any other projects, this project have risks too. Risks related to the planning and execution of this dissertation. Some of the risks are related to equipment failure and data lost and to prevent that this happen I use \textit{Github} to backup the source developed to the project and this report. This backups are done in all days that I do some improvements to this project.
...
This risks, the preventative measures and the recovery measures can be seen at Appendix \ref{App:B} in other perspective.
