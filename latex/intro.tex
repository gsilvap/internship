...
They are characterized by the placement of data and software on remote infrastructure. \red{Despite} of the numerous benefits, the reliability of these platforms hasn't keep the needs, and users trust on their applications to systems outside of personal control.
...
The \red{main} objective of this work is to build a tool to inject software faults in code of some programs before the compilation.
...
\red{Finally}, in the last section I will do an overview analyses to my work, in general the operators and the constraints developed. I will also talk in the work to be done in the next semester.
