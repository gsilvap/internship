...
%\red{Table of more representative faults of Durães}
	...
	\end{itemize}
	This constraint doesn't exists in João Durães specification, but as this operator cannot be applyed in all situations, I implemented and specify it.
