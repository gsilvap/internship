...
In the Table \ref{tab:swifi_hwifi}, it is possible to view that can be used SWIFI technique to take software to emulate software and hardware faults, and can be user HWIFI technique to emulate hardware faults through hardware.
