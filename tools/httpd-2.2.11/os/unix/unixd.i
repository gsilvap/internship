...
static int set_group_privs(void)
{
    if (!geteuid()) {
        ...
        if (unixd_config.user_name[0] == '#') {
            ...
            if ((ent = getpwuid(uid)) == ((void *)0)) {
                ap_log_error("unixd.c",75, 1, (*__errno_location ()), ((void *)0),
...
# 94 "unixd.c"
        if (setgid(unixd_config.group_id) == -1) {
            ap_log_error("unixd.c",95, 1, (*__errno_location ()), ((void *)0),
        ...
        if (initgroups(name, unixd_config.group_id) == -1) {
            ap_log_error("unixd.c",104, 1, (*__errno_location ()), ((void *)0),
...
int unixd_setup_child(void)
{
    ...
    if (((void *)0) != unixd_config.chroot_dir) {
        if (geteuid()) {
            ap_log_error("unixd.c",123, 1, (*__errno_location ()), ((void *)0),
                         "Cannot chroot when not started as root");
            return -1;
        }
        if (chdir(unixd_config.chroot_dir) != 0) {
            ap_log_error("unixd.c",128, 1, (*__errno_location ()), ((void *)0),
                         "Can't chdir to %s", unixd_config.chroot_dir);
            return -1;
        }
        if (chroot(unixd_config.chroot_dir) != 0) {
            ap_log_error("unixd.c",133, 1, (*__errno_location ()), ((void *)0),
                         "Can't chroot to %s", unixd_config.chroot_dir);
            return -1;
        }
        if (chdir("/") != 0) {
            ap_log_error("unixd.c",138, 1, (*__errno_location ()), ((void *)0),
...
# 159 "unixd.c"
    if (!geteuid() && (
        ...
        ap_log_error("unixd.c",164, 1, (*__errno_location ()), ((void *)0),
    ...
    if (ap_coredumpdir_configured) {
        if (prctl(4, 1)) {
            ap_log_error("unixd.c",174, 1, (*__errno_location ()), ((void *)0),
...
void unixd_pre_config(apr_pool_t *ptemp)
{
    ...
    unixd_config.chroot_dir = ((void *)0);


    unixd_config.suexec_enabled = 0;
    if ((apr_stat(&wrapper, "/home/user/Desktop/demo/installdir/" "/bin/suexec",
                  0x0073b170, ptemp)) != 0) {
        return;
    }

    if ((wrapper.protection & 0x8000) && wrapper.user == 0) {
                           ...
                           const char *arg, const char * arg2, int type)
{
    ...
    *plimit = (struct rlimit *)memset(apr_palloc(cmd->pool, sizeof(**plimit)), 0, sizeof(**plimit));
    ...
    if ((getrlimit(type, limit)) != 0) {
        *plimit = ((void *)0);
        ap_log_error("unixd.c",277, 3, (*__errno_location ()), cmd->server,
    ...
    if ((str = ap_getword_conf(cmd->pool, &arg))) {
        ...
        ap_log_error("unixd.c",291, 3, 0, cmd->server,
    ...
    if (geteuid()) {
        limit->rlim_cur = cur;
        if (max) {
            ap_log_error("unixd.c",304, 3, 0, cmd->server,
                              ...
                              apr_pool_t *p)
{
    ...
    newprogname = "/home/user/Desktop/demo/installdir/" "/bin/suexec";
    newargs[0] = "/home/user/Desktop/demo/installdir/" "/bin/suexec";
    newargs[1] = execuser;
    newargs[2] = execgroup;
...
apr_status_t unixd_accept(void **accepted, ap_listen_rec *lr,
                                        apr_pool_t *ptrans)
{
    apr_socket_t *csd;
    apr_status_t status;
...
# 578 "unixd.c"
        ...
        case 100:
# 619 "unixd.c"
            ap_log_error("unixd.c",619, 0, status, ap_server_conf,
                         "apr_socket_accept: giving up.");
            return (20000 + 14);
# 635 "unixd.c"
        default:
            ap_log_error("unixd.c",636, 3, status, ap_server_conf,
