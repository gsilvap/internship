...
# 151 "mod_log_config.c" 2
# 1 "/usr/include/apr-1/apr_anylock.h" 1
# 24 "/usr/include/apr-1/apr_anylock.h"
...
# 25 "/usr/include/apr-1/apr_anylock.h" 2

# 1 "/usr/include/apr-1/apr_thread_rwlock.h" 1
# 42 "/usr/include/apr-1/apr_thread_rwlock.h"
typedef struct apr_thread_rwlock_t apr_thread_rwlock_t;
# 60 "/usr/include/apr-1/apr_thread_rwlock.h"
...
# 27 "/usr/include/apr-1/apr_anylock.h" 2
...
# 157 "mod_log_config.c" 2
# 1 "mod_log_config.h" 1
# 27 "mod_log_config.h"
...
# 28 "mod_log_config.h" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/scoreboard.h" 1
# 30 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/scoreboard.h"
...
# 31 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/scoreboard.h" 2
...
# 32 "/usr/include/apr-1/apr_thread_proc.h"
...
# 39 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/scoreboard.h" 2
...
# 40 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/scoreboard.h" 2
# 1 "/usr/include/apr-1/apr_shm.h" 1
...
# 162 "mod_log_config.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_protocol.h" 1
# 32 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_protocol.h"
# 1 "/usr/include/apr-1/apr_mmap.h" 1
...
# 163 "mod_log_config.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_time.h" 1
# 54 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_time.h"
apr_status_t ap_explode_recent_localtime(apr_time_exp_t *tm,
                                                     apr_time_t t);
# 68 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_time.h"
...
# 164 "mod_log_config.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_mpm.h" 1
# 91 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_mpm.h"
...
# 114 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_mpm.h"
apr_status_t ap_os_create_privileged_process(
    ...
    apr_procattr_t *attr,
    apr_pool_t *p);
# 161 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_mpm.h"
apr_status_t ap_mpm_query(int query_code, int *result);
# 165 "mod_log_config.c" 2
...
# 168 "mod_log_config.c" 2


# 1 "/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.2/include-fixed/limits.h" 1 3 4
# 171 "mod_log_config.c" 2
...
static apr_array_header_t *all_buffered_logs = ((void *)0);
# 235 "mod_log_config.c"
typedef struct {
...
static const char *log_request_query(request_rec *r, char *a)
{
    return (r->args) ? apr_pstrcat(r->pool, "?",
                                   ap_escape_logitem(r->pool, r->args), ((void *)0))
                     : "";
}
...
static __inline__ char *find_multiple_headers(apr_pool_t *pool,
...
{
    apr_time_exp_t xt;
# 557 "mod_log_config.c"
    if (a && *a) {
# 567 "mod_log_config.c"
        ...
        unsigned t_seconds = (unsigned)((request_time) / 1000000L);
        unsigned i = t_seconds & 3;
        *cached_time = request_time_cache[i];
        if ((t_seconds != cached_time->t) ||
            ...
            apr_snprintf(cached_time->timestr, 32,
...
static const char *log_request_duration(request_rec *r, char *a)
{
    ...
    return apr_psprintf(r->pool, "%" "ld", ((duration) / 1000000L));
}

static const char *log_request_duration_microseconds(request_rec *r, char *a)
{
    return apr_psprintf(r->pool, "%" "ld",
...
static const char *log_server_port(request_rec *r, char *a)
{
    ...
    if (*a == '\0' || !strcasecmp(a, "canonical")) {
        port = r->server->port ? r->server->port : ap_run_default_port(r);
    }
...
{
    if (buf->outcnt && buf->handle != ((void *)0)) {
                                  ...
                                  apr_array_header_t *default_format)
{
    ...
    if (cls->condition_var != ((void *)0)) {
        envar = cls->condition_var;
        if (*envar != '!') {
            if (apr_table_get(r->subprocess_env, envar) == ((void *)0)) {
                return -1;
            }
        }
        else {
            if (apr_table_get(r->subprocess_env, &envar[1]) != ((void *)0)) {
                return -1;
            }
        }
    }
    ...
    if (!log_writer) {
        ap_log_rerror("mod_log_config.c",989, 3, (20000 + 14), r,
...
{
    multi_log_state *mls = (((void **)(r->server->module_config))[(&log_config_module)->module_index])
                                                                   ;
...
static void *make_config_log_state(apr_pool_t *p, server_rec *s)
{
    ...
    mls->default_format_string = ((void *)0);
    mls->default_format = ((void *)0);
    mls->server_config_logs = ((void *)0);
                              ...
                              const char *name)
{
    ...
    multi_log_state *mls = (((void **)(cmd->server->module_config))[(&log_config_module)->module_index])
                                                                   ;
...
static const char *set_transfer_log(cmd_parms *cmd, void *dummy,
                                    const char *fn)
{
    return add_custom_log(cmd, dummy, fn, ((void *)0), ((void *)0));
}

static const char *set_cookie_log(cmd_parms *cmd, void *dummy, const char *fn)
{
    return add_custom_log(cmd, dummy, fn, "%{Cookie}n \"%r\" %t", ((void *)0));
}
...
{
{ "CustomLog", { .take3=add_custom_log }, ((void *)0), 128, TAKE23, "a file name, a custom log format string or format name, " "and an optional \"env=\" clause (see docs)" }

                                                  ,
{ "TransferLog", { .take1=set_transfer_log }, ((void *)0), 128, TAKE1, "the filename of the access log" }
                                      ,
{ "LogFormat", { .take2=log_format }, ((void *)0), 128, TAKE12, "a log format string (see docs) and an optional format name" }
                                                                  ,
{ "CookieLog", { .take1=set_cookie_log }, ((void *)0), 128, TAKE1, "the filename of the cookie log" }
                                      ,
{ "BufferedLogs", { .flag=set_buffered_logs_on }, ((void *)0), 128, FLAG, "Enable Buffered Logging (experimental)" }
                                                          ,
    {((void *)0)}
};
...
{
    int i;
    multi_log_state *mls = (((void **)(s->module_config))[(&log_config_module)->module_index])
                                                                ;
    config_log_state *clsarray;
    const char *dummy;
    const char *format;
...
static apr_status_t flush_all_logs(void *data)
{
    ...
    for (; s; s = s->next) {
        mls = (((void **)(s->module_config))[(&log_config_module)->module_index]);
        log_list = ((void *)0);
        if (mls->config_logs->nelts) {
        ...
        for (i = 0; i < all_buffered_logs->nelts; i++) {
            ...
            if (mpm_threads > 1) {
                ...
                rv = apr_thread_mutex_create(&this->mutex.lock.tm,
                                             ...
                                             p);
                if (rv != 0) {
                    ap_log_error("mod_log_config.c",1329, 2, rv, s,
                                        ...
                                        const char* name)
{
    if (*name == '|') {
        ...
        if (!fname) {
            ap_log_error("mod_log_config.c",1411, 3, (20000 + 24), s,
                            "invalid transfer log path %s.", name);
            return ((void *)0);
        }
        rv = apr_file_open(&fd, fname, xfer_flags, xfer_perms, p);
        if (rv != 0) {
            ap_log_error("mod_log_config.c",1417, 3, rv, s,
...
{
    buffered_log *b;
    b = memset(apr_palloc(p, sizeof(buffered_log)), 0, sizeof(buffered_log));
...

{
    ...
    if ((rv = (((&buf->mutex)->type == apr_anylock_none) ? 0 : (((&buf->mutex)->type == apr_anylock_threadmutex) ? apr_thread_mutex_lock((&buf->mutex)->lock.tm) : (((&buf->mutex)->type == apr_anylock_procmutex) ? apr_proc_mutex_lock((&buf->mutex)->lock.pm) : (((&buf->mutex)->type == apr_anylock_readlock) ? apr_thread_rwlock_rdlock((&buf->mutex)->lock.rw) : (((&buf->mutex)->type == apr_anylock_writelock) ? apr_thread_rwlock_wrlock((&buf->mutex)->lock.rw) : 22)))))) != 0) {
        return rv;
    }

    if (len + buf->outcnt > 4096) {
        flush_log(buf);
    }
    if (len >= 4096) {
        apr_size_t w;
    ...
    (((&buf->mutex)->type == apr_anylock_none) ? 0 : (((&buf->mutex)->type == apr_anylock_threadmutex) ? apr_thread_mutex_unlock((&buf->mutex)->lock.tm) : (((&buf->mutex)->type == apr_anylock_procmutex) ? apr_proc_mutex_unlock((&buf->mutex)->lock.pm) : ((((&buf->mutex)->type == apr_anylock_readlock) || ((&buf->mutex)->type == apr_anylock_writelock)) ? apr_thread_rwlock_unlock((&buf->mutex)->lock.rw) : 22))));
    return rv;
}
...
{
    ap_hook_pre_config(log_pre_config,((void *)0),((void *)0),(-10));
    ap_hook_child_init(init_child,((void *)0),((void *)0),10);
    ap_hook_open_logs(init_config_log,((void *)0),((void *)0),10);
    ap_hook_log_transaction(multi_log_transaction,((void *)0),((void *)0),10);
    ...
    do { apr_OFN_ap_register_log_handler_t *apu__opt = ap_register_log_handler; apr_dynamic_fn_register("ap_register_log_handler",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ap_log_set_writer_init_t *apu__opt = ap_log_set_writer_init; apr_dynamic_fn_register("ap_log_set_writer_init",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ap_log_set_writer_t *apu__opt = ap_log_set_writer; apr_dynamic_fn_register("ap_log_set_writer",(apr_opt_fn_t *)apu__opt); } while (0);
}

module log_config_module =
{
    20051115, 21, -1, "mod_log_config.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
    ((void *)0),
    ((void *)0),
