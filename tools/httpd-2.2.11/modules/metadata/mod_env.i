                                              ...
                                              const char *arg)
{
    ...
    if (env_var != ((void *)0)) {
        ...
        ap_log_error("mod_env.c",104, 4, 0, cmd->server,
                                             ...
                                             const char *arg)
{
    ...
    apr_table_set(sconf->unsetenv, arg, ((void *)0));
...
{
{ "PassEnv", { .take1=add_env_module_vars_passed }, ((void *)0), 4, ITERATE, "a list of environment variables to pass to CGI." }
                                                                    ,
{ "SetEnv", { .take2=add_env_module_vars_set }, ((void *)0), 4, TAKE12, "an environment variable name and optional value to pass to CGI." }
                                                                                    ,
{ "UnsetEnv", { .take1=add_env_module_vars_unset }, ((void *)0), 4, ITERATE, "a list of variables to remove from the CGI environment." }
                                                                            ,
    {((void *)0)},
};
...
static int fixup_env_module(request_rec *r)
{
    ...
    env_dir_config_rec *sconf = (((void **)(r->per_dir_config))[(&env_module)->module_index])
                                                                 ;
    apr_table_t *vars = sconf->vars;
...
{
    ap_hook_fixups(fixup_env_module, ((void *)0), ((void *)0), 10);
}

module env_module =
{
    20051115, 21, -1, "mod_env.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
