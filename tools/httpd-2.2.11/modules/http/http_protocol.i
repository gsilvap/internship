...
# 37 "http_protocol.c" 2

# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/httpd.h" 1
# 39 "http_protocol.c" 2
...
# 60 "http_protocol.c" 2
# 75 "http_protocol.c"
static const char * const status_lines[57] =
...
static struct { apr_array_header_t *link_insert_error_filter; } _hooks;



void ap_hook_insert_error_filter(ap_HOOK_insert_error_filter_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_insert_error_filter_t *pHook; if(!_hooks.link_insert_error_filter) { _hooks.link_insert_error_filter=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_insert_error_filter_t)); apr_hook_sort_register("insert_error_filter",&_hooks.link_insert_error_filter); } pHook=apr_array_push(_hooks.link_insert_error_filter); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("insert_error_filter",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_insert_error_filter(void) { return _hooks.link_insert_error_filter; } void ap_run_insert_error_filter (request_rec *r) { ap_LINK_insert_error_filter_t *pHook; int n; ; ; if(_hooks.link_insert_error_filter) { pHook=(ap_LINK_insert_error_filter_t *)_hooks.link_insert_error_filter->elts; for(n=0 ; n < _hooks.link_insert_error_filter->nelts ; ++n) { ; pHook[n].pFunc (r); ; } } ; }
# 162 "http_protocol.c"
int ap_set_keepalive(request_rec *r)
{
    int ka_sent = 0;
            ...
            if (r->server->keep_alive_max) {
                apr_table_setn(r->headers_out, "Keep-Alive",
                       apr_psprintf(r->pool, "timeout=%d, max=%d",
                            (int)((r->server->keep_alive_timeout) / 1000000L),
                            left));
            }
            else {
                apr_table_setn(r->headers_out, "Keep-Alive",
...
int ap_meets_conditions(request_rec *r)
{
    ...
    int not_modified = 0;
# 289 "http_protocol.c"
    if (!(((r->status) >= 200)&&((r->status) < 300)) || r->no_local_copy) {
        return 0;
    }
    ...
    if ((if_match = apr_table_get(r->headers_in, "If-Match")) != ((void *)0)) {
        ...
        if (if_unmodified != ((void *)0)) {
            apr_time_t ius = apr_date_parse_http(if_unmodified);

            if ((ius != ((apr_time_t)0)) && (mtime > ((ius) / 1000000L))) {
                return 412;
            }
        }
    }
...
# 374 "http_protocol.c"
    if (r->method_number == 0
        ...
        ims = ((ims_time) / 1000000L);
        reqtime = ((r->request_time) / 1000000L);
...
# 404 "http_protocol.c"
static apr_hash_t *methods_registry = ((void *)0);
                                ...
                                int methnum)
{
    ...
    *pnum = methnum;
    apr_hash_set(methods_registry, methname, (-1), pnum);
}
...
{
    methods_registry = ((void *)0);
    cur_method_number = (26 + 1);
    return 0;
}
...
void ap_method_registry_init(apr_pool_t *p)
{
    ...
    apr_pool_cleanup_register(p, ((void *)0),
...
int ap_method_register(apr_pool_t *p, const char *methname)
{
    ...
    if (cur_method_number > 62) {
        ...
        ap_log_perror("http_protocol.c",488, 3, 0, p,
...
static char *make_allow(request_rec *r)
{
    ...
    core_server_config *conf =
        (((void **)(r->server->module_config))[(&core_module)->module_index]);
    ...
    for (; hi; hi = apr_hash_next(hi)) {
        ...
        apr_hash_this(hi, &key, ((void *)0), &val);
        if ((mask & (((apr_int64_t)1) << *(int *)val)) != 0) {
    ...
    if ((mask & (((apr_int64_t)1) << 26))
        && (r->allowed_methods->method_list != ((void *)0))
                                      ...
                                      const char *suffix)
{
    ...
    if ((notes = apr_table_get(r->notes, key)) == ((void *)0)) {
                                           ...
                                           const char *location)
{
    ...
    case 501:
        ...
        return(add_optional_notes(r, s1, "error-notes", "</p>\n"));
    case 502:
        s1 = "<p>The proxy server received an invalid" "\015\012"
            "response from an upstream server.<br />" "\015\012";
        return(add_optional_notes(r, s1, "error-notes", "</p>\n"));
    case 506:
        return(apr_pstrcat(p,
    ...
    default:
        ...
        if (((error_notes = apr_table_get(r->notes,
                                          "error-notes")) != ((void *)0))
            && (h1 = apr_table_get(r->notes, "verbose-error-to")) != ((void *)0)
            && (strcmp(h1, "*") == 0)) {
...
void ap_send_error_response(request_rec *r, int recursive_error)
{
    ...
    if (!r->assbackwards) {
        ...
        r->content_languages = ((void *)0);
        r->content_encoding = ((void *)0);
        r->clength = 0;

        if (apr_table_get(r->subprocess_env,
                          "suppress-error-charset") != ((void *)0)) {
...
# 1220 "http_protocol.c"
    ...
    }
    {
        ...
        if (r->status_line != ((void *)0)
            && strlen(r->status_line) > 4
            && (((*__ctype_b_loc ())[(int) ((((unsigned char)(r->status_line[0]))))] & (unsigned short int) _ISdigit))
            && (((*__ctype_b_loc ())[(int) ((((unsigned char)(r->status_line[1]))))] & (unsigned short int) _ISdigit))
            && (((*__ctype_b_loc ())[(int) ((((unsigned char)(r->status_line[2]))))] & (unsigned short int) _ISdigit))
            && (((*__ctype_b_loc ())[(int) ((((unsigned char)(r->status_line[3]))))] & (unsigned short int) _ISspace))
            && (((*__ctype_b_loc ())[(int) ((((unsigned char)(r->status_line[4]))))] & (unsigned short int) _ISalnum))) {
            title = r->status_line;
        }
...
int ap_method_in_list(ap_method_list_t *l, const char *method)
{
    ...
    if (methnum != 26) {
        return !!(l->method_mask & (((apr_int64_t)1) << methnum));
    }



    if ((l->method_list == ((void *)0)) || (l->method_list->nelts == 0)) {
        return 0;
    }
...
void ap_method_list_add(ap_method_list_t *l, const char *method)
{
    ...
    methnum = ap_method_number_of(method);
    l->method_mask |= (((apr_int64_t)1) << methnum);
    if (methnum != 26) {
        return;
    }
