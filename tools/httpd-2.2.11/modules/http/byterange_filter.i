# 1 "byterange_filter.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "byterange_filter.c"
# 21 "byterange_filter.c"
...
# 34 "byterange_filter.c" 2

# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/httpd.h" 1
# 36 "byterange_filter.c" 2
                                                         ...
                                                         apr_bucket_brigade *bb)
{
    ...
    while ((current = ap_getword(r->pool, &r->range, ','))
        ...
        if ((rv = apr_brigade_partition(bb, range_start, &ec)) != 0) {
            ap_log_rerror("byterange_filter.c",231, 3, rv, r,
                          "apr_brigade_partition() failed " "[%" "ld" ",%" "ld" "]", range_start, clength);
            continue;
        }
        if ((rv = apr_brigade_partition(bb, range_end+1, &e2)) != 0) {
            ap_log_rerror("byterange_filter.c",236, 3, rv, r,
                          "apr_brigade_partition() failed " "[%" "ld" ",%" "ld" "]", range_end+1, clength);
            continue;
        }
        ...
        do {
            ...
            if ((ec)->type->copy(ec, &foo) != 0) {





                (ec)->type->read(ec, &str, &len, APR_BLOCK_READ);
                (ec)->type->copy(ec, &foo);
            }
            do { apr_bucket *ap__b = (foo); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(bsend)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(bsend)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(bsend)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(bsend)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
            ec = ((ec))->link.next;
        } while (ec != e2);
    }
