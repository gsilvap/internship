...
static const command_rec mime_cmds[] =
{
    ...
    { "RemoveOutputFilter", { .take1=remove_extension_info }, (void *)((long) (((char *) (&(((extension_info*)((void *)0))->output_filters))) - ((char *) ((void *)0)))), 4, ITERATE, "one or more file extensions" }
                                      ...
                                      ,
    { "RemoveType", { .take1=remove_extension_info }, (void *)((long) (((char *) (&(((extension_info*)((void *)0))->forced_type))) - ((char *) ((void *)0)))), 4, ITERATE, "one or more file extensions" }
...
static int mime_post_config(apr_pool_t *p, apr_pool_t *plog, apr_pool_t *ptemp, server_rec *s)
{
    ...
    if (!types_confname) {
        ap_log_error("mod_mime.c",427, 3, (20000 + 24), s,
                     "Invalid mime types config path %s",
                     (const char *)(((void **)(s->module_config))[(&mime_module)->module_index])
                                                                     );
        return 500;
    }
    if ((status = ap_pcfg_openfile(&f, ptemp, types_confname))
                != 0) {
        ap_log_error("mod_mime.c",435, 3, status, s,
...
static content_type *analyze_ct(request_rec *r, const char *s)
{
    ...
    if (!*cp) {
        ap_log_error("mod_mime.c",549, 4, 0, ss,
    ...
    if (!*cp || (*cp == ';')) {
        ap_log_error("mod_mime.c",559, 4, 0, ss,
    ...
    if (*cp != '/') {
        ap_log_error("mod_mime.c",568, 4, 0, ss,
                     "mod_mime: analyze_ct: cannot get media type from '%s'",
                     (const char *) mp);
        return (((void *)0));
    }
    ...
    if (!*cp) {
        ap_log_error("mod_mime.c",582, 4, 0, ss,
    ...
    cp = zap_sp(cp);
    if (cp == ((void *)0) || *cp == '\0') {
        ap_log_error("mod_mime.c",603, 4, 0, ss,
        ...
        if (attribute == ((void *)0)) {
            if (is_token(*cp) > 0) {
                ...
                if (attribute == ((void *)0) || *attribute == '\0') {
                    ap_log_error("mod_mime.c",624, 4, 0, ss,
                                 "Cannot get media parameter.");
                    return (((void *)0));
                }
                cp++;
                cp = zap_sp(cp);
                if (cp == ((void *)0) || *cp == '\0') {
                    ap_log_error("mod_mime.c",631, 4, 0, ss,
                                 "Cannot get media parameter.");
                    return (((void *)0));
                }
                mp = cp;
                ...
                ap_log_error("mod_mime.c",639, 4, 0, ss,
                             "Cannot get media parameter.");
                return (((void *)0));
            }
        }
            ...
            if (quoted > 0) {
                while (quoted && *cp != '\0') {
                    if (is_qtext(*cp) > 0) {
                        ...
                        if (*cp != ';' && *cp != '\0') {
                            ap_log_error("mod_mime.c",668, 4, 0, ss,
                                         "Cannot get media parameter.");
                            return(((void *)0));
                        }
                        quoted = 0;
                        ...
                        ap_log_error("mod_mime.c",675, 4, 0, ss,
                                     "Cannot get media parameter.");
                        return (((void *)0));
                    }
                }
                ...
                while (1) {
                    if (is_token(*cp) > 0) {
                        ...
                        ap_log_error("mod_mime.c",690, 4, 0, ss,
                                     "Cannot get media parameter.");
                        return (((void *)0));
                    }
                }
            ...
            if (value == ((void *)0) || *value == '\0') {
                ap_log_error("mod_mime.c",698, 4, 0, ss,
                             "Cannot get media parameter.");
                return (((void *)0));
            }
...
static int find_ct(request_rec *r)
{
    ...
    char *ext;
    const char *fn, *type, *charset = ((void *)0), *resource_name;
    ...
    *((const char **)apr_array_push(exception_list)) = ext;
    ...
    while (*fn && (ext = ap_getword(r->pool, &fn, '.'))) {
        ...
        if (exinfo != ((void *)0)) {
            ...
            if (exinfo->input_filters && r->proxyreq == 0) {
            ...
            if (exinfo->output_filters && r->proxyreq == 0) {
...
module mime_module = {
    20051115, 21, -1, "mod_mime.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
