...
# 20 "/usr/include/apr-1/apr_optional.h"
# 1 "/usr/include/apr-1/apu.h" 1
# 21 "/usr/include/apr-1/apr_optional.h" 2
...
# 26 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_config.h"
...
# 26 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_filter.h"
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 27 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_filter.h" 2
...
# 32 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_core.h"
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_filter.h" 1
...
# 616 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_core.h"
...
# 39 "mod_include.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h" 1
# 51 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
char ** ap_create_environment(apr_pool_t *p, apr_table_t *t);
# 62 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
...
# 90 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
int ap_scan_script_header_err(request_rec *r, apr_file_t *f, char *buffer);
# 103 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
int ap_scan_script_header_err_brigade(request_rec *r,
                                                  apr_bucket_brigade *bb,
                                                  char *buffer);
# 121 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
int ap_scan_script_header_err_strs(request_rec *r,
                                                      char *buffer,
                                                      const char **termch,
                                                      int *termarg, ...);
# 139 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_script.h"
...
static void decodehtml(char *s)
{
    ...
    char *p;
    const char *ents;
    static const char * const entlist[(6) + 1] =
    {
        ((void *)0),
        ((void *)0),
        "lt\074gt\076",
    ...
    for (p = s; *s != '\0'; s++, p++) {
        ...
        if (s[1] == '#') {
            for (j = 2, val = 0; j < i && (((*__ctype_b_loc ())[(int) ((((unsigned char)(s[j]))))] & (unsigned short int) _ISdigit)); j++) {
                val = val * 10 + s[j] - '0';
            }
            s += i;
...
static const char *add_include_vars_lazy(request_rec *r, const char *var)
{
    ...
    if (!strcasecmp(var, "DATE_LOCAL")) {
        include_dir_config *conf =
            (include_dir_config *)(((void **)(r->per_dir_config))[(&include_module)->module_index])
                                                                       ;
        ...
        if (apr_uid_name_get(&val, r->finfo.user, r->pool) != 0) {
            val = "<unknown>";
        }
    }
    else {
...
static const char *get_include_var(const char *var, include_ctx_t *ctx)
{
    ...
    if ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*var))))] & (unsigned short int) _ISdigit)) && !var[1]) {
        ...
        if (!re) {
            ap_log_rerror("mod_include.c",661, 4, 0, r,
                "regex capture $%" "lu" " refers to no regex in %s",
                idx, r->filename);
            return ((void *)0);
        }
        else {
            if (re->nsub < idx || idx >= 10) {
                ap_log_rerror("mod_include.c",668, 4, 0, r,
                              "regex capture $%" "lu"
...
{
    request_rec *r = ctx->intern->r;
    result_item_t *result = ((void *)0), *current = ((void *)0);
    apr_size_t outlen = 0, inlen, span;
    char *ret = ((void *)0), *eout = ((void *)0);
    const char *p;

    if (out) {

        ((out && length) ? (void)0 : ap_log_assert("out && length","mod_include.c",711));
    ...
    do {
        ...
        if (*p == '\\') {
            ...
            const char *newp = ((void *)0), *ep, *key = ((void *)0);

            if (*++p == '{') {
                ep = strchr(++p, '}');
                if (!ep) {
                    ap_log_rerror("mod_include.c",789, 3, 0, r, "Missing '}' on "
                ...
                ep = p;
                while (*ep == '_' || (((*__ctype_b_loc ())[(int) ((((unsigned char)(*ep))))] & (unsigned short int) _ISalnum))) {
                    ++ep;
                }
...
# 921 "mod_include.c"
static __inline__ int re_check(include_ctx_t *ctx, const char *string,
                               const char *rexp)
{
    ap_regex_t *compiled;
    backref_t *re = ctx->intern->re;
    ...
    compiled = ap_pregcomp(ctx->dpool, rexp, (0));
    if (!compiled) {
        ap_log_rerror("mod_include.c",930, 3, 0, ctx->intern->r, "unable to "
    ...
    rc = !ap_regexec(compiled, string, 10, re->match, 0);
...
static int get_ptoken(include_ctx_t *ctx, const char **parse, token_t *token, token_t *previous)
{
    ...
    while ((((*__ctype_b_loc ())[(int) ((((unsigned char)(**parse))))] & (unsigned short int) _ISspace))) {
        ++*parse;
    }
    ...
    case '/':
        ...
        if (previous != ((void *)0) && TOKEN_ACCESS == previous->type) {
            break;
        }
        (token)->type = TOKEN_RE;
        unmatched = '/';
    ...
    for (; **parse; p = ++*parse) {
        if (**parse == '\\') {
            ...
            } else if ((((*__ctype_b_loc ())[(int) ((((unsigned char)(**parse))))] & (unsigned short int) _ISspace))) {
                break;
            }
            else {
                int found = 0;
...
{
    parse_node_t *new, *root = ((void *)0), *current = ((void *)0);
    request_rec *r = ctx->intern->r;
    ...
    *was_error = 0;
    ...
    while (1) {
        ...
        do { (new) = apr_palloc((ctx)->dpool, sizeof(*(new))); (new)->parent = (new)->left = (new)->right = ((void *)0); (new)->done = 0; } while(0);

        was_unmatched = get_ptoken(ctx, &parse, &new->token,
                         (current != ((void *)0) ? &current->token : ((void *)0)));
        if (!parse) {
            break;
        }
        ...
        if (!current) {
            ...
            default:
                ap_log_rerror("mod_include.c",1168, 3, 0, r, error, expr,
                              r->filename);
                *was_error = 1;
                return 0;
            }
        ...
        ap_log_rerror("mod_include.c",1318, 3, 0, r, error, expr, r->filename);
        *was_error = 1;
        return 0;
    }
    ...
    while (current) {
        ...
        case TOKEN_STRING:
            current->token.value =
                ap_ssi_parse_string(ctx, current->token.value, ((void *)0), 0,
                                    0);
        ...
        case TOKEN_OR:
            if (!current->left || !current->right) {
                ap_log_rerror("mod_include.c",1340, 3, 0, r,
        ...
        case TOKEN_NE:
            if (!current->left || !current->right ||
                ...
                ap_log_rerror("mod_include.c",1405, 3, 0, r,
                            "Invalid expression \"%s\" in file %s",
                            expr, r->filename);
                *was_error = 1;
                return 0;
            ...
            current->left->token.value =
                ap_ssi_parse_string(ctx, current->left->token.value, ((void *)0), 0,
                                    0);
            current->right->token.value =
                ap_ssi_parse_string(ctx, current->right->token.value, ((void *)0), 0,
                                    0);
        ...
        case TOKEN_LT:
            if (!current->left || !current->right ||
                current->left->token.type != TOKEN_STRING ||
                current->right->token.type != TOKEN_STRING) {
                ap_log_rerror("mod_include.c",1440, 3, 0, r,
                              "Invalid expression \"%s\" in file %s",
                              expr, r->filename);
                *was_error = 1;
                return 0;
        ...
        case TOKEN_ACCESS:
            if (current->left || !current->right ||
                (current->right->token.type != TOKEN_STRING &&
                 current->right->token.type != TOKEN_RE)) {
                ap_log_rerror("mod_include.c",1488, 3, 0, r,
            ...
            current->right->token.value =
                ap_ssi_parse_string(ctx, current->right->token.value, ((void *)0), 0,
                                    0);
            rr = ap_sub_req_lookup_uri(current->right->token.value, r, ((void *)0));
            ...
            if (rr->status < 400) {
                ...
                current->value = 0;
                ap_log_rerror("mod_include.c",1504, 7, rr->status, r,
        ...
        default:
            ...
            ap_log_rerror("mod_include.c",1525, 3, 0, r, error, expr,r->filename);
            *was_error = 1;
            return 0;
        }
                     ...
                     char *tag_val, apr_finfo_t *finfo)
{
    ...
    if (!strcmp(tag, "file")) {
        ...
        rv = apr_filepath_merge(&newpath, ((void *)0), tag_val,
                                0x02 |
                                0x08, r->pool);
        ...
        if (rv != 0) {
            ...
            rr = ap_sub_req_lookup_file(newpath, r, ((void *)0));

            if (rr->status == 200 && rr->finfo.filetype != 0) {
                to_send = rr->filename;
                if ((rv = apr_stat(finfo, to_send,
                    0x00200000 | 0x00008170, rr->pool)) != 0
                    && rv != ((20000 + 50000) + 8)) {
        ...
        if (error_fmt) {
            ret = -1;
            ap_log_rerror("mod_include.c",1618, 3,
        ...
        rr = ap_sub_req_lookup_uri(tag_val, r, ((void *)0));
        ...
        if (rr->status == 200 && rr->finfo.filetype != 0) {
            ...
            ap_log_rerror("mod_include.c",1638, 3, 0, r, "unable to get "
        ...
        ap_log_rerror("mod_include.c",1646, 3, 0, r, "unknown parameter \"%s\" "
                                   ...
                                   apr_bucket_brigade *bb)
{
    ...
    if (!ctx->argc) {
        ap_log_rerror("mod_include.c",1661,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    while (1) {
        ...
        if (strcmp(tag, "virtual") && strcmp(tag, "file")) {
            ap_log_rerror("mod_include.c",1690, 3, 0, r, "unknown parameter "
                          "\"%s\" to tag include in %s", tag, r->filename);
            do { apr_bucket *ap__b = (apr_bucket_pool_create(apr_pstrdup((ctx)->pool, (ctx)->error_str), strlen((ctx)->error_str), (ctx)->pool, (f)->c->bucket_alloc)); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
            break;
        }

        parsed_string = ap_ssi_parse_string(ctx, tag_val, ((void *)0), 0,
                                            0);
        if (tag[0] == 'f') {
            char *newpath;
            apr_status_t rv;
            ...
            rv = apr_filepath_merge(&newpath, ((void *)0), parsed_string,
                                    0x02 |
                                    0x08, ctx->dpool);
        ...
        if (rr) {
            ((((void **)(rr->request_config))[(&include_module)->module_index]) = (r));
        }
        ...
        if (error_fmt) {
            ap_log_rerror("mod_include.c",1742, 3, 0, r, error_fmt, tag_val,
                          r->filename);
            do { apr_bucket *ap__b = (apr_bucket_pool_create(apr_pstrdup((ctx)->pool, (ctx)->error_str), strlen((ctx)->error_str), (ctx)->pool, (f)->c->bucket_alloc)); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
        }
                                ...
                                apr_bucket_brigade *bb)
{
    ...
    if (!ctx->argc) {
        ap_log_rerror("mod_include.c",1770,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    while (1) {
        ...
        if (!strcmp(tag, "var")) {
            const char *val;
            const char *echo_text = ((void *)0);
            apr_size_t e_len;

            val = get_include_var(ap_ssi_parse_string(ctx, tag_val, ((void *)0),
                                                      0, 0),
                                  ctx);
            ...
            if (val) {
                ...
                case E_NONE:
                    ...
                    break;
                case E_URL:
                    echo_text = ap_os_escape_path(ctx->dpool,val,1);
                    break;
                case E_ENTITY:
            ...
            if (!strcasecmp(tag_val, "none")) {
                ...
                ap_log_rerror("mod_include.c",1841, 3, 0, r, "unknown value "
            ...
            ap_log_rerror("mod_include.c",1849, 3, 0, r, "unknown parameter "
                                  ...
                                  apr_bucket_brigade *bb)
{
    ...
    if (!ctx->argc) {
        ap_log_rerror("mod_include.c",1870,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    while (1) {
        ...
        if (!strcmp(tag, "errmsg")) {
            ctx->error_str = ap_ssi_parse_string(ctx, tag_val, ((void *)0), 0,
                                                 0);
        }
        else if (!strcmp(tag, "echomsg")) {
            ctx->intern->undefined_echo =
                ap_ssi_parse_string(ctx, tag_val, ((void *)0), 0,0);
            ctx->intern->undefined_echo_len=strlen(ctx->intern->undefined_echo);
        }
        else if (!strcmp(tag, "timefmt")) {
            apr_time_t date = r->request_time;

            ctx->time_str = ap_ssi_parse_string(ctx, tag_val, ((void *)0), 0,
                                                0);
            ...
            if (!strcmp(parsed_string, "bytes")) {
                ...
                ap_log_rerror("mod_include.c",1930, 3, 0, r, "unknown value "
            ...
            ap_log_rerror("mod_include.c",1938, 3, 0, r, "unknown parameter "
                                 ...
                                 apr_bucket_brigade *bb)
{
    ...
    if (!ctx->argc) {
        ap_log_rerror("mod_include.c",1957,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    while (1) {
        ...
        if (!find_file(r, "fsize", tag, parsed_string, &finfo)) {
            ...
            if (!(ctx->flags & (1<<2))) {
                ...
                tmp = apr_psprintf(ctx->dpool, "%" "ld", finfo.size);
                len = l = strlen(tmp);
                                    ...
                                    apr_bucket_brigade *bb)
{
    ...
    if (!ctx->argc) {
        ap_log_rerror("mod_include.c",2044,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
                              ...
                              apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc != 1) {
        ap_log_rerror("mod_include.c",2105,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
                      0, r, (ctx->argc)
    ...
    ap_ssi_get_tag_and_value(ctx, &tag, &expr, 0);

    if (strcmp(tag, "expr")) {
        ap_log_rerror("mod_include.c",2127, 3, 0, r, "unknown parameter \"%s\" "
    ...
    if (!expr) {
        ap_log_rerror("mod_include.c",2134, 3, 0, r, "missing expr value for if "
                                ...
                                apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc != 1) {
        ap_log_rerror("mod_include.c",2175,
                      (!(ctx->if_nesting_level)) ? 3 : 4,
                      0, r, (ctx->argc)
                                ? "too many arguments for if element in %s"
                                : "missing expr argument for if element in %s",
                      r->filename);
    ...
    if (strcmp(tag, "expr")) {
        ap_log_rerror("mod_include.c",2195, 3, 0, r, "unknown parameter \"%s\" "
                      "to tag if in %s", tag, r->filename);
        do { apr_bucket *ap__b = (apr_bucket_pool_create(apr_pstrdup((ctx)->pool, (ctx)->error_str), strlen((ctx)->error_str), (ctx)->pool, (f)->c->bucket_alloc)); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&((bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
        return 0;
    }
    ...
    if (!expr) {
        ap_log_rerror("mod_include.c",2202, 3, 0, r, "missing expr in elif "
                                ...
                                apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc) {
        ap_log_rerror("mod_include.c",2244,
                      (!(ctx->if_nesting_level)) ? 3 : 4,
                                 ...
                                 apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc) {
        ap_log_rerror("mod_include.c",2283,
                      (!(ctx->if_nesting_level)) ? 3 : 4,
                               ...
                               apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc < 2) {
        ap_log_rerror("mod_include.c",2318,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    while (1) {
        ...
        if (!strcmp(tag, "var")) {
            var = ap_ssi_parse_string(ctx, tag_val, ((void *)0), 0,
                                      0);
        }
            ...
            if (!var) {
                ap_log_rerror("mod_include.c",2360, 3, 0, r, "variable must "
            ...
            ap_log_rerror("mod_include.c",2373, 3, 0, r, "Invalid tag for set "
                                    ...
                                    apr_bucket_brigade *bb)
{
    ...
    if (ctx->argc) {
        ap_log_rerror("mod_include.c",2395,
                      (ctx->flags & (1<<0))
                          ? 3 : 4,
    ...
    for (i = 0; i < arr->nelts; ++i) {
        ...
        val_text = elts[i].val;
        if (val_text == (&lazy_eval_sentinel)) {
                                 ...
                                 apr_size_t **store_len)
{
    ...
    case PARSE_DIRECTIVE:
        while (p < ep && !(((*__ctype_b_loc ())[(int) ((((unsigned char)(*p))))] & (unsigned short int) _ISspace))) {
    ...
    case PARSE_DIRECTIVE_POSTNAME:
        ...
        if (!intern->directive_len) {
            intern->error = 1;
            ap_log_rerror("mod_include.c",2788, 3, 0, intern->r, "missing "
                                ...
                                apr_size_t **store_len)
{
    ...
    case PARSE_ARG:
        ...
        intern->current_arg->next = ((void *)0);
        ...
        case '"': case '\'': case '`':
            *store = ((void *)0);
            ...
            intern->quote = *p++;
            intern->current_arg->name = ((void *)0);
            intern->current_arg->name_len = 0;
            intern->error = 1;

            ap_log_rerror("mod_include.c",2924, 3, 0, intern->r, "missing "
    ...
    case PARSE_ARG_NAME:
        while (p < ep && !(((*__ctype_b_loc ())[(int) ((((unsigned char)(*p))))] & (unsigned short int) _ISspace)) && *p != '=') {
            ++p;
        }
    ...
    case PARSE_ARG_POSTNAME:
        ...
        if (!intern->current_arg->name_len) {
            intern->error = 1;
            ap_log_rerror("mod_include.c",2956, 3, 0, intern->r, "missing "
                          "argument name for value to tag %s in %s",
                          apr_pstrmemdup(intern->r->pool, intern->directive,
                                         intern->directive_len),
                                         intern->r->filename);
        ...
        *store = ((void *)0);
        ...
        if (p < ep) {
            if (*p == '=') {
                ...
                intern->current_arg->value = ((void *)0);
                intern->state = PARSE_PRE_ARG;
            }
    ...
    case PARSE_ARG_VAL:
        for (; p < ep; ++p) {
            ...
            else if (!intern->quote && (((*__ctype_b_loc ())[(int) ((((unsigned char)(*p))))] & (unsigned short int) _ISspace))) {
                ++p;
                *store = &intern->current_arg->value;
                *store_len = &intern->current_arg->value_len;
                intern->state = PARSE_ARG_POSTVAL;
...
static apr_status_t send_parsed_content(ap_filter_t *f, apr_bucket_brigade *bb)
{
    ...
    while (b != (struct apr_bucket *)((char *)(&(&(bb)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))) {
        const char *data = ((void *)0);
        apr_size_t len, index, release;
        apr_bucket *newb = ((void *)0);
        char **store = &magic;
        apr_size_t *store_len = ((void *)0);


        if (((b)->type->is_metadata)) {
            newb = ((b))->link.next;

            do { (((((b))))->link.prev)->link.next = ((((b))))->link.next; (((((b))))->link.next)->link.prev = ((((b))))->link.prev; } while (0);
...
# 3166 "mod_include.c"
                if (PARSE_EXECUTE == intern->state ||
                    ...
                    do { apr_bucket *ap__a = (newb), *ap__b = (b); do { (((ap__b)))->link.next = ((ap__a)); (((ap__b)))->link.prev = (((ap__a)))->link.prev; ((((ap__a)))->link.prev)->link.next = ((ap__b)); (((ap__a)))->link.prev = ((ap__b)); } while (0); ; } while (0);
                }
                else {
                    break;
                }
                ...
                do { apr_bucket *ap__b = (b); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(pass_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(pass_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(pass_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(pass_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
        ...
        if (ctx->flush_now ||
            intern->bytes_read > 8000) {

            if (!(((&(pass_bb)->list))->next == (struct apr_bucket *)((char *)(&((&(pass_bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0))))))) {
        ...
        if (!intern->seen_eos) {
            if (intern->bytes_read > 0) {
                rv = (b)->type->read(b, &data, &len, APR_NONBLOCK_READ);
                if (((rv) == 11)) {
                    ctx->flush_now = 1;
                    continue;
                }
            ...
            if (!len || rv != 0) {
                rv = (b)->type->read(b, &data, &len, APR_BLOCK_READ);
            }
        ...
        case PARSE_PRE_HEAD:
            ...
            if (index < len) {
                ...
                if (PARSE_DIRECTIVE == intern->state) {
                    (newb)->type->split(newb, intern->start_seq_pat->pattern_len);
                    ctx->flush_now = 1;
                }

                b = ((newb))->link.next;
                do { do { (((((newb))))->link.prev)->link.next = ((((newb))))->link.next; (((((newb))))->link.next)->link.prev = ((((newb))))->link.prev; } while (0); do { (newb)->type->destroy((newb)->data); (newb)->free(newb); } while (0); } while (0);
            }
            else {
                b = newb;
            }
        ...
        case PARSE_DIRECTIVE_POSTTAIL:
            ...
            if (store) {
                if (index) {
                    do { (((((b))))->link.prev)->link.next = ((((b))))->link.next; (((((b))))->link.next)->link.prev = ((((b))))->link.prev; } while (0);
                    (b)->type->setaside(b,r->pool);
                    do { apr_bucket *ap__b = (b); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
                    b = newb;
                }
        ...
        case PARSE_TAIL_SEQ:
            ...
            case PARSE_ARG:
                ...
                do { do { if (!((((&(intern->tmp_bb)->list)))->next == (struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0))))))) { do { ((((&(intern->tmp_bb)->list))->next))->link.prev = ((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((&(intern->tmp_bb)->list))->prev))->link.next = (((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.next; ((((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.next)->link.prev = (((&(intern->tmp_bb)->list))->prev); (((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.next = (((&(intern->tmp_bb)->list))->next); } while (0); do { (((&(intern->tmp_bb)->list)))->next = (struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0))))); (((&(intern->tmp_bb)->list)))->prev = (struct apr_bucket *)((char *)(&(((&(intern->tmp_bb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0))))); } while (0); } } while (0); ; } while (0);
                b = (&(bb)->list)->next;
                break;
        ...
        case PARSE_EXECUTE:
            ...
            if (intern->error) {
                if (ctx->flags & (1<<0)) {
                    do { apr_bucket *ap__b = (apr_bucket_pool_create(apr_pstrdup((ctx)->pool, (ctx)->error_str), strlen((ctx)->error_str), (ctx)->pool, (f)->c->bucket_alloc)); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&((pass_bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&((pass_bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&((pass_bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&((pass_bb))->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
                    intern->error = 0;
                }
            }
            else {
                ...
                if (handle_func) {
                    ...
                    ap_log_rerror("mod_include.c",3439, 3, 0, r,
    ...
    if (intern->seen_eos) {
        if (PARSE_HEAD == intern->state) {
            ...
            ap_log_rerror("mod_include.c",3476, 3, 0, r,
        ...
        if (!(ctx->flags & (1<<0))) {
            ap_log_rerror("mod_include.c",3485, 4, 0, r,
...
{
    include_dir_config *conf = (((void **)(f->r->per_dir_config))[(&include_module)->module_index])
                                                                    ;
    ...
    if ((conf->xbithack != XBITHACK_FULL)
        || !(f->r->finfo.valid & 0x00200000)
        || !(f->r->finfo.protection & 0x0010)) {
        f->r->no_local_copy = 1;
    }
...
static apr_status_t includes_filter(ap_filter_t *f, apr_bucket_brigade *b)
{
    ...
    include_ctx_t *ctx = f->ctx;
    request_rec *parent;
    include_dir_config *conf = (((void **)(r->per_dir_config))[(&include_module)->module_index])
                                                                    ;

    include_server_config *sconf= (((void **)(r->server->module_config))[(&include_module)->module_index])
                                                                       ;

    if (!(ap_allow_options(r) & 2)) {
        ap_log_rerror("mod_include.c",3555, 4, 0, r,
    ...
    if (!f->ctx) {
        ...
        ctx->pool = r->pool;
        apr_pool_create_ex(&ctx->dpool, ctx->pool, ((void *)0), ((void *)0));
    ...
    if ((parent = (((void **)(r->request_config))[(&include_module)->module_index]))) {
...
# 3631 "mod_include.c"
    if ((conf->xbithack == XBITHACK_FULL)
        && (r->finfo.valid & 0x00200000)
        && (r->finfo.protection & 0x0010)) {
...
static int include_fixup(request_rec *r)
{
    ...
    conf = (((void **)(r->per_dir_config))[(&include_module)->module_index]);
...
static void *create_includes_dir_config(apr_pool_t *p, char *dummy)
{
    ...
    result->default_error_msg = "[an error occurred while processing this directive]";
    result->default_time_fmt = "%A, %d-%b-%Y %H:%M:%S %Z";
    result->undefined_echo = "(none)";
    result->xbithack = XBITHACK_OFF;
...
static void *create_includes_server_config(apr_pool_t *p, server_rec *server)
{
    ...
    result->default_end_tag = "-->";
    result->default_start_tag = "<!--#";
                                         ...
                                         const char *tag)
{
    ...
    while (*p) {
        if ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*p))))] & (unsigned short int) _ISspace))) {
            return "SSIStartTag may not contain any whitespaces";
        }
        ++p;
    }

    conf= (((void **)(cmd->server->module_config))[(&include_module)->module_index]);
...
{
    { "XBitHack", { .take1=set_xbithack }, ((void *)0), 2, TAKE1, "Off, On, or Full" }
                                     ,
    { "SSIErrorMsg", { .take1=set_default_error_msg }, ((void *)0), (1|2|4|8|16), TAKE1, "a string" }
                             ,
    { "SSITimeFormat", { .take1=set_default_time_fmt }, ((void *)0), (1|2|4|8|16), TAKE1, "a strftime(3) formatted string" }
                                                   ,
    { "SSIStartTag", { .take1=set_default_start_tag }, ((void *)0), 128, TAKE1, "SSI Start String Tag" }
                                         ,
    { "SSIEndTag", { .take1=set_default_end_tag }, ((void *)0), 128, TAKE1, "SSI End String Tag" }
                                       ,
    { "SSIUndefinedEcho", { .take1=set_undefined_echo }, ((void *)0), (1|2|4|8|16), TAKE1, "String to be displayed if an echoed variable is undefined" }
                                                                              ,
    { "SSIAccessEnable", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((include_dir_config*)((void *)0))->accessenable))) - ((char *) ((void *)0)))), 1, FLAG, "Whether testing access is enabled. Limited to 'on' or 'off'" }
...
{
    do { apr_OFN_ap_ssi_get_tag_and_value_t *apu__opt = ap_ssi_get_tag_and_value; apr_dynamic_fn_register("ap_ssi_get_tag_and_value",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ap_ssi_parse_string_t *apu__opt = ap_ssi_parse_string; apr_dynamic_fn_register("ap_ssi_parse_string",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ap_register_include_handler_t *apu__opt = ap_register_include_handler; apr_dynamic_fn_register("ap_register_include_handler",(apr_opt_fn_t *)apu__opt); } while (0);
    ap_hook_post_config(include_post_config, ((void *)0), ((void *)0), (-10));
    ap_hook_fixups(include_fixup, ((void *)0), ((void *)0), 20);
...
module include_module =
{
    20051115, 21, -1, "mod_include.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
