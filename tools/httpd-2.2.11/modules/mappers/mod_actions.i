...
static void *create_action_dir_config(apr_pool_t *p, char *dummy)
{
    ...
    (action_dir_config *) memset(apr_palloc(p, sizeof(action_dir_config)), 0, sizeof(action_dir_config));
                              ...
                              const char *option)
{
    ...
    if (option && strcasecmp(option, "virtual")) {
        return apr_pstrcat(cmd->pool,
                           "unrecognized option '", option, "'", ((void *)0));
    }

    apr_table_setn(m->action_types, type,
                   apr_pstrcat(cmd->pool, option ? "1" : "0", script, ((void *)0)));
    m->configured = 1;
...
{
    { "Action", { .take3=add_action }, ((void *)0), 4, TAKE23, "a media type followed by a script name" }
                                                           ,
    { "Script", { .take2=set_script }, ((void *)0), 64 | 128, TAKE2, "a method followed by a script name" }
                                                       ,
    {((void *)0)}
};
...
static int action_handler(request_rec *r)
{
    action_dir_config *conf = (action_dir_config *)
        (((void **)(r->per_dir_config))[(&actions_module)->module_index]);
    const char *t, *action;
    const char *script;
    int i;
    ...
    if ((t = apr_table_get(conf->action_types, action))) {
        if (*t++ == '0' && r->finfo.filetype == 0) {
            ap_log_rerror("mod_actions.c",185, 3, 0, r,
...
{
    ap_hook_handler(action_handler,((void *)0),((void *)0),20);
}

module actions_module =
{
    20051115, 21, -1, "mod_actions.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
