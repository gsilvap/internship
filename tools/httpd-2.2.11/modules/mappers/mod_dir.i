...
{
    { "DirectoryIndex", { .take1=add_index }, ((void *)0), 16, ITERATE, "a list of file names" }
                                           ,
...
static int fixup_dir(request_rec *r)
{
    ...
    for (; num_names; ++names_ptr, --num_names) {
        ...
        rr = ap_sub_req_lookup_uri(name_ptr, r, ((void *)0));
# 195 "mod_dir.c"
        if (rr->status == 200
...
{
    ap_hook_fixups(fixup_dir,((void *)0),((void *)0),20);
}

module dir_module = {
    20051115, 21, -1, "mod_dir.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
    create_dir_config,
    merge_dir_configs,
    ((void *)0),
    ((void *)0),
