...
# 33 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/os/unix/unixd.h" 2
...
# 36 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/os/unix/unixd.h" 2
...
# 39 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/os/unix/unixd.h" 2
...
{
    userdir_config *newcfg = memset(apr_palloc(p, sizeof(*newcfg)), 0, sizeof(*newcfg));

    newcfg->globally_disabled = 0;
    newcfg->userdir = ((void *)0);
...
{
    userdir_config *s_cfg = (((void **)(cmd->server->module_config))[(&userdir_module)->module_index])
                                                                 ;
    char *username;
...
static const command_rec userdir_cmds[] = {
    { "UserDir", { .raw_args=set_user_dir }, ((void *)0), 128, RAW_ARGS, "the public subdirectory in users' home directories, or " "'disabled', or 'disabled username username...', or " "'enabled username username...'" }
...
static int translate_userdir(request_rec *r)
{
    ...
    s_cfg = (((void **)(server_conf))[(&userdir_module)->module_index]);
...
# 217 "mod_userdir.c"
    ...
    if (apr_table_get(s_cfg->disabled_users, w) != ((void *)0)) {
        return -1;
    }
    ...
    if (s_cfg->globally_disabled
        && apr_table_get(s_cfg->enabled_users, w) == ((void *)0)) {
        return -1;
    }
...
# 267 "mod_userdir.c"
            ...
            if (apr_uid_homepath_get(&homedir, w, r->pool) == 0) {
        ...
        if (filename && (!*userdirs
                      || ((rv = apr_stat(&statbuf, filename, 0x00008170,
                                         r->pool)) == 0
                                             || rv == ((20000 + 50000) + 8)))) {
...
{
    ap_unix_identity_t *ugid = ((void *)0);
    ...
    if ((ugid = apr_palloc(r->pool, sizeof(*ugid))) == ((void *)0)) {
        return ((void *)0);
    }

    if (apr_uid_get(&ugid->uid, &ugid->gid, username, r->pool) != 0) {
        return ((void *)0);
    }
...
{
    static const char * const aszPre[]={ "mod_alias.c",((void *)0) };
    static const char * const aszSucc[]={ "mod_vhost_alias.c",((void *)0) };

    ap_hook_translate_name(translate_userdir,aszPre,aszSucc,10);

    ap_hook_get_suexec_identity(get_suexec_id_doer,((void *)0),((void *)0),0);

}

module userdir_module = {
    20051115, 21, -1, "mod_userdir.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
    ((void *)0),
    ((void *)0),
