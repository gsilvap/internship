...
# 25 "/usr/include/apr-1/apr_dso.h"
# 1 "/usr/include/apr-1/apr.h" 1
...
# 27 "/usr/include/apr-1/apr_dso.h" 2
...
static void *so_sconf_create(apr_pool_t *p, server_rec *s)
{
    ...
    soc = (so_server_conf *)memset(apr_palloc(p, sizeof(so_server_conf)), 0, sizeof(so_server_conf));
    soc->loaded_modules = apr_array_make(p, 128,
                               ...
                               const char *modname, const char *filename)
{
    ...
    *(ap_directive_t **)dummy = ((void *)0);
    ...
    for (i = 0; i < sconf->loaded_modules->nelts; i++) {
        modi = &modie[i];
        if (modi->name != ((void *)0) && strcmp(modi->name, modname) == 0) {
            ap_log_perror("mod_so.c",187, 4, 0,
    ...
    if (apr_dso_load(&modhandle, szModuleFile, cmd->pool) != 0) {
        char my_error[256];
    ...
    ap_log_perror("mod_so.c",246, 7, 0, cmd->pool,
    ...
    if (apr_dso_sym(&modsym, modhandle, modname) != 0) {
        char my_error[256];
...
static const char *load_file(cmd_parms *cmd, void *dummy, const char *filename)
{
    ...
    if (apr_dso_load(&handle, file, cmd->pool) != 0) {
        char my_error[256];
    ...
    ap_log_error("mod_so.c",328, 7, 0, ((void *)0),
...
static module *ap_find_loaded_module_symbol(server_rec *s, const char *modname)
{
    ...
    sconf = (so_server_conf *)(((void **)(s->module_config))[(&so_module)->module_index])
                                                              ;
    modie = (ap_module_symbol_t *)sconf->loaded_modules->elts;
...
static void register_hooks(apr_pool_t *p)
{
    ...
    do { apr_OFN_ap_find_loaded_module_symbol_t *apu__opt = ap_find_loaded_module_symbol; apr_dynamic_fn_register("ap_find_loaded_module_symbol",(apr_opt_fn_t *)apu__opt); } while (0);
    ap_hook_test_config(dump_loaded_modules, ((void *)0), ((void *)0), 10);

}

static const command_rec so_cmds[] = {
    { "LoadModule", { .take2=load_module }, ((void *)0), 128 | 256, TAKE2, "a module name and the name of a shared object file to load it from" }
                                                                           ,
    { "LoadFile", { .take1=load_file }, ((void *)0), 128 | 256, ITERATE, "shared object file or library to load into the server at runtime" }
                                                                         ,
    { ((void *)0) }
};

module so_module = {
   20051115, 21, -1, "mod_so.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
   ((void *)0),
   ((void *)0),
   so_sconf_create,
   ((void *)0),
