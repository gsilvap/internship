# 1 "mod_authn_default.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "mod_authn_default.c"
# 17 "mod_authn_default.c"
...
{
    { "AuthDefaultAuthoritative", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((authn_default_config_rec*)((void *)0))->authoritative))) - ((char *) ((void *)0)))), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules if the UserID is not known to this module. " "(default is On)." }
...
module authn_default_module;

static int authenticate_no_user(request_rec *r)
{
    authn_default_config_rec *conf = (((void **)(r->per_dir_config))[(&authn_default_module)->module_index])
                                                                            ;
    ...
    ap_log_rerror("mod_authn_default.c",80, 3, 0, r,
...
{
    ap_hook_check_user_id(authenticate_no_user,((void *)0),((void *)0),20);
}

module authn_default_module =
{
    20051115, 21, -1, "mod_authn_default.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
