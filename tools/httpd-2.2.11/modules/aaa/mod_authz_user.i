...
{
    { "AuthzUserAuthoritative", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((authz_user_config_rec*)((void *)0))->authoritative))) - ((char *) ((void *)0)))), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules if the 'require user' or 'require valid-user' " "statement is not met. (default: On)." }
...
{
    authz_user_config_rec *conf = (((void **)(r->per_dir_config))[(&authz_user_module)->module_index])
                                                                          ;
    char *user = r->user;
    ...
    ap_log_rerror("mod_authz_user.c",106, 3, 0, r,
...
{
    ap_hook_auth_checker(check_user_access, ((void *)0), ((void *)0), 10);
}

module authz_user_module =
{
    20051115, 21, -1, "mod_authz_user.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
