...
# 21 "mod_authn_file.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_provider.h" 1
# 29 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_provider.h"
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_config.h" 1
# 30 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/ap_provider.h" 2
...
apr_array_header_t * ap_list_provider_names(apr_pool_t *pool,
                                              const char *provider_group,
                                              const char *provider_version);
# 22 "mod_authn_file.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/httpd.h" 1
# 44 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/httpd.h"
                                       ...
                                       const char *f, const char *t)
{
    if (t && strcmp(t, "standard")) {
        return apr_pstrcat(cmd->pool, "Invalid auth file type: ", t, ((void *)0));
    }
...
{
    { "AuthUserFile", { .take2=set_authn_file_slot }, (void *)((long) (((char *) (&(((authn_file_config_rec*)((void *)0))->pwfile))) - ((char *) ((void *)0)))), 8, TAKE12, "text file containing user IDs and passwords" }
...
static authn_status check_password(request_rec *r, const char *user,
                                   const char *password)
{
    authn_file_config_rec *conf = (((void **)(r->per_dir_config))[(&authn_file_module)->module_index])
                                                                          ;
    ap_configfile_t *f;
    char l[8192];
    apr_status_t status;
    char *file_password = ((void *)0);

    status = ap_pcfg_openfile(&f, r->pool, conf->pwfile);

    if (status != 0) {
        ap_log_rerror("mod_authn_file.c",76, 3, status, r,
                                   ...
                                   const char *realm, char **rethash)
{
    ...
    char l[8192];
    apr_status_t status;
    char *file_hash = ((void *)0);

    status = ap_pcfg_openfile(&f, r->pool, conf->pwfile);

    if (status != 0) {
        ap_log_rerror("mod_authn_file.c",124, 3, status, r,
                      "Could not open password file: %s", conf->pwfile);
        return AUTH_GENERAL_ERROR;
    }
...
{
    ap_register_provider(p, "authn", "file", "0",
                         &authn_file_provider);
}

module authn_file_module =
{
    20051115, 21, -1, "mod_authn_file.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
