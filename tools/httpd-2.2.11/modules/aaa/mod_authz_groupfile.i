# 1 "mod_authz_groupfile.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "mod_authz_groupfile.c"
# 46 "mod_authz_groupfile.c"
...
{
    { "AuthGroupFile", { .take2=set_authz_groupfile_slot }, (void *)((long) (((char *) (&(((authz_groupfile_config_rec*)((void *)0))->groupfile))) - ((char *) ((void *)0)))), 8, TAKE12, "text file containing group names and member user IDs" }


                                                                          ,
    { "AuthzGroupFileAuthoritative", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((authz_groupfile_config_rec*)((void *)0))->authoritative))) - ((char *) ((void *)0)))), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules if the 'require group' fails. (default is " "On)." }
...
static int check_user_access(request_rec *r)
{
    ...
    for (x = 0; x < reqs_arr->nelts; x++) {
        ...
        if (!(reqs[x].method_mask & (((apr_int64_t)1) << m))) {
            continue;
        }
        ...
        if (!strcasecmp(w, "group") || filegroup) {
            ...
            if (!grpstatus) {
                ...
                if (status != 0) {
                    ap_log_rerror("mod_authz_groupfile.c",216, 3, status, r,
    ...
    ap_log_rerror("mod_authz_groupfile.c",263, 3, 0, r,
...
{
    static const char * const aszPre[]={ "mod_authz_owner.c", ((void *)0) };

    ap_hook_auth_checker(check_user_access, aszPre, ((void *)0), 10);
}

module authz_groupfile_module =
{
    20051115, 21, -1, "mod_authz_groupfile.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
