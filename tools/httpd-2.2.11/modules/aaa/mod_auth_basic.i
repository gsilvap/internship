...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 20 "mod_auth_basic.c" 2
# 1 "/usr/include/apr-1/apr_base64.h" 1
# 60 "/usr/include/apr-1/apr_base64.h"
int apr_base64_encode_len(int len);
# 69 "/usr/include/apr-1/apr_base64.h"
int apr_base64_encode(char * coded_dst, const char *plain_src,
                                 int len_plain_src);
# 79 "/usr/include/apr-1/apr_base64.h"
...
{
    auth_basic_config_rec *conf = memset(apr_palloc(p, sizeof(*conf)), 0, sizeof(*conf));
...
{
    { "AuthBasicProvider", { .take1=add_authn_provider }, ((void *)0), 8, ITERATE, "specify the auth providers for a directory or location" }
                                                                             ,
    { "AuthBasicAuthoritative", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((auth_basic_config_rec*)((void *)0))->authoritative))) - ((char *) ((void *)0)))), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules if the UserID is not known to this module" }
                          ...
                          const char **pw)
{
    ...
    auth_line = apr_table_get(r->headers_in, (1 == r->proxyreq)
                                              ? "Proxy-Authorization"
                                              : "Authorization");
    ...
    if (strcasecmp(ap_getword(r->pool, &auth_line, ' '), "Basic")) {
        ...
        ap_log_rerror("mod_auth_basic.c",148, 3, 0, r,
    ...
    while ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*auth_line))))] & (unsigned short int) _ISspace))) {
        auth_line++;
    }
...
{
    auth_basic_config_rec *conf = (((void **)(r->per_dir_config))[(&auth_basic_module)->module_index])
                                                                          ;
    ...
    if (!ap_auth_name(r)) {
        ap_log_rerror("mod_auth_basic.c",193, 3,
    ...
    do {
        ...
        if (!current_provider) {
            ...
            if (!provider || !provider->check_password) {
                ap_log_rerror("mod_auth_basic.c",217, 3, 0, r,
    ...
    if (auth_result != AUTH_GRANTED) {
        ...
        switch (auth_result) {
        case AUTH_DENIED:
            ap_log_rerror("mod_auth_basic.c",257, 3, 0, r,
        ...
        case AUTH_USER_NOT_FOUND:
            ap_log_rerror("mod_auth_basic.c",264, 3, 0, r,
...
{
    ap_hook_check_user_id(authenticate_basic_user,((void *)0),((void *)0),10);
}

module auth_basic_module =
{
    20051115, 21, -1, "mod_auth_basic.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
