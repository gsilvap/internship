...
{
    { "AuthzDefaultAuthoritative", { .flag=ap_set_flag_slot }, (void *)((long) (((char *) (&(((authz_default_config_rec*)((void *)0))->authoritative))) - ((char *) ((void *)0)))), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules. (default is On.)" }
...
module authz_default_module;

static int check_user_access(request_rec *r)
{
    authz_default_config_rec *conf = (((void **)(r->per_dir_config))[(&authz_default_module)->module_index])
                                                                       ;
...
# 93 "mod_authz_default.c"
    ap_log_rerror("mod_authz_default.c",93, 3, 0, r,
...
{
    ap_hook_auth_checker(check_user_access,((void *)0),((void *)0),20);
}

module authz_default_module =
{
    20051115, 21, -1, "mod_authz_default.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
