...
static int asis_handler(request_rec *r)
{
    ...
    if(strcmp(r->handler,"httpd/send-as-is") && strcmp(r->handler,"send-as-is"))
        return -1;
    ...
    if (r->finfo.filetype == 0) {
        ap_log_rerror("mod_asis.c",45, 3, 0, r,
                    "File does not exist: %s", r->filename);
        return 404;
    }

    if ((rv = apr_file_open(&f, r->filename, 0x00001,
                0x0FFF, r->pool)) != 0) {
        ap_log_rerror("mod_asis.c",52, 3, rv, r,
                    "file permissions deny server access: %s", r->filename);
        return 403;
    }

    ap_scan_script_header_err(r, f, ((void *)0));
    ...
    if (!r->header_only) {
        ...
        if (rv != 0) {
            ap_log_rerror("mod_asis.c",85, 3, rv, r,
...
# 112 "mod_asis.c"
        ...
        if (rv != 0) {
            ap_log_rerror("mod_asis.c",119, 3, rv, r,
...
{
    ap_hook_handler(asis_handler,((void *)0),((void *)0),10);
}

module asis_module =
{
    20051115, 21, -1, "mod_asis.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
    ((void *)0),
    ((void *)0),
    ((void *)0),
    ((void *)0),
