...
{
    { "ExtendedStatus", { .flag=set_extended_status }, ((void *)0), 128, FLAG, "\"On\" to enable extended status information, \"Off\" to disable" }
                                                                         ,
    { "SeeRequestTail", { .flag=set_reqtail }, ((void *)0), 128, FLAG, "For verbose requests, \"On\" to see the last 63 chars of the request, " "\"Off\" (default) to see the first 63 in extended status display" }
...
static int status_handler(request_rec *r)
{
    ...
    if (strcmp(r->handler, "application/x-httpd-status") &&
    ...
    if (!ap_exists_scoreboard_image()) {
        ap_log_rerror("mod_status.c",279, 3, 0, r,
    ...
    if (r->args) {
        ...
        while (status_options[i].id != -1) {
            if ((loc = strstr(r->args, status_options[i].form_data_str)
                                                                   ) != ((void *)0)) {
...
module status_module =
{
    20051115, 21, -1, "mod_status.c", ((void *)0), ((void *)0), 0x41503232UL, ((void *)0),
    ((void *)0),
    ((void *)0),
    ((void *)0),
    ((void *)0),
