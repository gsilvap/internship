...
yield = (unsigned char*)(pcre_malloc)(((512 + 320) + 256));
...
for (i = 0; i < 256; i++)
  {
  if (((*__ctype_b_loc ())[(int) ((i))] & (unsigned short int) _ISdigit))
    {
    p[64 + i/8] |= 1 << (i&7);
    p[160 + i/8] |= 1 << (i&7);
    }
...
for (i = 0; i < 256; i++)
  {
  int x = 0;
  if (i != 0x0b && ((*__ctype_b_loc ())[(int) ((i))] & (unsigned short int) _ISspace)) x += 0x01;
  if (((*__ctype_b_loc ())[(int) ((i))] & (unsigned short int) _ISalpha)) x += 0x02;
  if (((*__ctype_b_loc ())[(int) ((i))] & (unsigned short int) _ISdigit)) x += 0x04;
  if (((*__ctype_b_loc ())[(int) ((i))] & (unsigned short int) _ISxdigit)) x += 0x08;
