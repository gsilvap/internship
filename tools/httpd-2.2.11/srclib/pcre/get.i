...
if ((rc = pcre_fullinfo(code, ((void *)0), 8, &top)) != 0)
  return rc;
if (top <= 0) return (-7);

if ((rc = pcre_fullinfo(code, ((void *)0), 7, &entrysize)) != 0)
  return rc;
if ((rc = pcre_fullinfo(code, ((void *)0), 9, &nametable)) != 0)
  return rc;
