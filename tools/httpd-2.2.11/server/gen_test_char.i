...
# 80 "gen_test_char.c"
        ...
        if (!(((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _ISalnum)) && !strchr("$-_.+!*'(),:@&=~", c)) {
            flags |= (0x02);
        }
        ...
        if (c && ((((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _IScntrl)) || strchr(" \t()<>@,;:\\\"/[]?={}", c))) {
            flags |= (0x08);
        }
        ...
        if (c && (!(((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _ISprint)) || c == '"' || c == '\\' || (((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _IScntrl)))) {
            flags |= (0x10);
        }
        ...
        if (!(((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _ISprint)) || c == ':' || c == '|' || c == '%'
            || (((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _IScntrl)) || !c) {
            flags |= (0x20);
        }
