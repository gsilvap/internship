    ...
    for (x = 0, y = 0; expected[y]; ++y, ++x) {
        ...
        if (expected[y] == '*') {
            ...
            return -1;
                 ...
                 && (tolower(((unsigned char)(str[x])))) != (tolower(((unsigned char)(expected[y])))))
            return 1;
    }
    return (str[x] != '\0');
}
...
char * ap_strcasestr(const char *s1, const char *s2)
{
    ...
    while(1) {
        for ( ; (*s1 != '\0') && ((tolower(((unsigned char)(*s1)))) != (tolower(((unsigned char)(*s2))))); s1++);
        if (*s1 == '\0') {
            return(((void *)0));
        }
        ...
        p1 = (char *)s1;
        p2 = (char *)s2;
        for (++p1, ++p2; (tolower(((unsigned char)(*p1)))) == (tolower(((unsigned char)(*p2)))); ++p1, ++p2) {
            if (*p1 == '\0') {
                              ...
                              ap_regmatch_t pmatch[])
{
    ...
    while ((c = *src++) != '\0') {
        if (c == '&')
            no = 0;
        else if (c == '$' && (((*__ctype_b_loc ())[(int) ((((unsigned char)(*src))))] & (unsigned short int) _ISdigit)))
            no = *src++ - '0';
        else
            no = 10;
    ...
    dest = dst = memset(apr_palloc(p, len + 1), 0, len + 1);
                                          ...
                                          apr_pool_t *p, const char *name)
{
    ...
    if (name == ((void *)0)) {
        ap_log_error("util.c",899, 3, 0, ((void *)0),
    ...
    if (finfo.filetype != APR_REG &&
        ...
        ap_log_error("util.c",925, 3, 0, ((void *)0),
...
int ap_cfg_getline(char *buf, size_t bufsize, ap_configfile_t *cfp)
{
    ...
    if (cfp->getstr != ((void *)0)) {
        ...
        while (1) {
            ++cfp->line_number;
            if (cfp->getstr(cbuf, cbufsize, cfp->param) == ((void *)0))
                return 1;
        ...
        src = buf;
        while ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*src))))] & (unsigned short int) _ISspace)))
            ++src;

        dst = &src[strlen(src)];
        while (--dst >= src && (((*__ctype_b_loc ())[(int) ((((unsigned char)(*dst))))] & (unsigned short int) _ISspace)))
            *dst = '\0';
        ...
        while (1) {
            ...
            if (c == (-1) || c == 0x4 || c == 10 || i >= (bufsize - 2)) {
                ...
                while (i > 0 && (((*__ctype_b_loc ())[(int) ((((unsigned char)(buf[i - 1]))))] & (unsigned short int) _ISspace)))
                    --i;
                buf[i] = '\0';
                ...
                switch (*ptr) {
                    ...
                    default : if (!good)
                               ...
                               if (in_com || in_qstr)
                                   ...
                                   good = good && (*pos++ == (tolower(((unsigned char)(*ptr)))));
                               addspace = 0;
                               break;
                }
            }
...
char *ap_get_local_host(apr_pool_t *a)
{
    ...
    if (apr_gethostname(str, sizeof(str) - 1, a) != 0) {
        ap_log_perror("util.c",2002, ((0x07 + 1) * 4) | 4, 0, a,
        ...
        if (apr_sockaddr_info_get(&sockaddr, str, 0, 0, 0, a) == 0) {
            ...
            ap_log_perror("util.c",2019, ((0x07 + 1) * 4) | 4, 0, a,
    ...
    ap_log_perror("util.c",2028, 1|((0x07 + 1) * 4), 0, a,
