...
# 48 "util_pcre.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/srclib/pcre/pcre.h" 1
# 149 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/srclib/pcre/pcre.h"
struct real_pcre;
...
# 195 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/srclib/pcre/pcre.h"
extern void *(*pcre_malloc)(size_t);
extern void (*pcre_free)(void *);
extern void *(*pcre_stack_malloc)(size_t);
extern void (*pcre_stack_free)(void *);
extern int (*pcre_callout)(pcre_callout_block *);
# 210 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/srclib/pcre/pcre.h"
...
if ((cflags & 0x01) != 0) options |= 0x0001;
if ((cflags & 0x02) != 0) options |= 0x0002;
...
if ((eflags & 0x04) != 0) options |= 0x0080;
if ((eflags & 0x08) != 0) options |= 0x0100;
