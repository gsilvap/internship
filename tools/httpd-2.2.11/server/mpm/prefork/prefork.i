...
# 30 "/usr/include/apr-1/apr_portable.h" 2
...
apr_status_t apr_mcast_interface(apr_socket_t *sock,
                                              apr_sockaddr_t *iface);
# 33 "/usr/include/apr-1/apr_portable.h" 2
...
# 52 "/usr/include/apr-1/apr_strings.h"
# 1 "/usr/include/apr-1/apr_want.h" 1
...
# 1 "/usr/include/apr-1/apr_thread_proc.h" 1
# 21 "prefork.c" 2
# 1 "/usr/include/apr-1/apr_signal.h" 1
# 57 "/usr/include/apr-1/apr_signal.h"
...
# 80 "/usr/include/apr-1/apr_signal.h"
...
# 29 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_main.h"
...
# 30 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/http_main.h" 2
...
static void accept_mutex_on(void)
{
    ...
    if (rv != 0) {
        ...
        if (ap_my_generation !=
            ...
            ap_log_error("prefork.c",211, 7, rv, ((void *)0), "%s", msg);
            clean_child_exit(0);
        }
        else {
            ap_log_error("prefork.c",215, 0, rv, ((void *)0), "%s", msg);
            exit(0xf);
        }
    }
}
...
static void accept_mutex_off(void)
{
    ...
    if (rv != 0) {
        ...
        if (ap_my_generation !=
            ap_scoreboard_image->global->running_generation) {
            ap_log_error("prefork.c",229, 7, rv, ((void *)0), "%s", msg);
            ...
            ap_log_error("prefork.c",236, 0, rv, ((void *)0), "%s", msg);
            exit(0xf);
        }
    }
}
...
static void set_signals(void)
{
    ...
    if (sigaction(15, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",386, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGTERM)");

    if (sigaction(28, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",389, 4, (*__errno_location ()), ap_server_conf,
                     "sigaction(" "SIGWINCH" ")");


    if (sigaction(2, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",394, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGINT)");


    sa.__sigaction_handler.sa_handler = ((__sighandler_t) 0);
    if (sigaction(24, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",399, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGXCPU)");


    sa.__sigaction_handler.sa_handler = ((__sighandler_t) 0);
    if (sigaction(25, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",404, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGXFSZ)");


    sa.__sigaction_handler.sa_handler = ((__sighandler_t) 1);
    if (sigaction(13, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",409, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGPIPE)");
    ...
    if (sigaction(1, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",419, 4, (*__errno_location ()), ap_server_conf, "sigaction(SIGHUP)");
    if (sigaction(10, &sa, ((void *)0)) < 0)
        ap_log_error("prefork.c",421, 4, (*__errno_location ()), ap_server_conf, "sigaction(" "SIGUSR1" ")");
# 447 "prefork.c"
}
...
static void child_main(int child_num_arg)
{
    ...
    apr_pool_create_ex(&pchild, pconf, ((void *)0), allocator);
    apr_allocator_owner_set(allocator, pchild);

    apr_pool_create_ex(&ptrans, pchild, ((void *)0), ((void *)0));
    ...
    if (status != 0) {
        ap_log_error("prefork.c",503, 0, status, ap_server_conf,
    ...
    (void) ap_update_child_status(sbh, 2, (request_rec *) ((void *)0));
        ...
        if (num_listensocks == 1) {
            ...
            for (;;) {
                ...
                if (status != 0) {
                    ...
                    ap_log_error("prefork.c",597, 3, status,
...
static int make_child(server_rec *s, int slot)
{
    ...
    if (one_process) {
        apr_signal(1, sig_term);

        apr_signal(2, sig_term);

        apr_signal(3, ((__sighandler_t) 0));

        apr_signal(15, sig_term);
        child_main(slot);
        return 0;
    }

    (void) ap_update_child_status_from_indexes(slot, 0, 1,
                                               (request_rec *) ((void *)0));
# 704 "prefork.c"
    if ((pid = fork()) == -1) {

        ap_log_error("prefork.c",706, 3, (*__errno_location ()), s, "fork: Unable to fork new process");




        (void) ap_update_child_status_from_indexes(slot, 0, 0,
                                                   (request_rec *) ((void *)0));
...
static void startup_children(int number_to_start)
{
    ...
    for (i = 0; number_to_start && i < ap_daemons_limit; ++i) {
        if (ap_scoreboard_image->servers[i][0].status != 0) {
            continue;
        }
...
static void perform_idle_server_maintenance(apr_pool_t *p)
{
    ...
    if (idle_count > ap_daemons_max_free) {
        ...
        if (free_length == 0) {
            ...
            if (!reported) {
                ap_log_error("prefork.c",855, 3, 0, ap_server_conf,
            ...
            if (idle_spawn_rate >= 8) {
                ap_log_error("prefork.c",864, 6, 0, ap_server_conf,
...
int ap_mpm_run(apr_pool_t *_pconf, apr_pool_t *plog, server_rec *s)
{
    ...
    if (changed_limit_at_restart) {
        ap_log_error("prefork.c",914, 4, 0, s,
    ...
    ap_lock_fname = apr_psprintf(_pconf, "%s.%" "d",
    ...
    if (rv != 0) {
        ap_log_error("prefork.c",928, 0, rv, s,
    ...
    if (ap_accept_lock_mech == APR_LOCK_DEFAULT ||
        ...
        if (rv != 0) {
            ap_log_error("prefork.c",943, 0, rv, s,
...
# 980 "prefork.c"
    ...
    ap_log_error("prefork.c",995, 5, 0, ap_server_conf,
                "%s configured -- resuming normal operations",
                ap_get_server_description());
    ap_log_error("prefork.c",998, 6, 0, ap_server_conf,
                "Server built: %s", ap_get_server_built());

    ap_log_error("prefork.c",1001, 7, 0, ap_server_conf,
    ...
    while (!restart_pending && !shutdown_pending) {
        ...
        if (pid.pid != -1) {
            ...
            if (child_slot >= 0) {
                (void) ap_update_child_status_from_indexes(child_slot, 0, 0,
                                                           (request_rec *) ((void *)0));
            ...
            else if (apr_proc_other_child_alert(&pid, 0, status) == 0) {
    ...
    if (shutdown_pending && !is_graceful) {
        ...
        if ((killpg ((getpgrp()), (15))) < 0) {
            ap_log_error("prefork.c",1101, 4, (*__errno_location ()), ap_server_conf, "killpg SIGTERM");
        }
...

        {
            ...
            if ( pidfile != ((void *)0) && unlink(pidfile) == 0)
                ap_log_error("prefork.c",1110, 6,
                                0, ap_server_conf,
                                "removed PID file %s (pid=%ld)",
                                pidfile, (long)getpid());
        }

        ap_log_error("prefork.c",1116, 5, 0, ap_server_conf,
        ...
        for (index = 0; index < ap_daemons_limit; ++index) {
            if (ap_scoreboard_image->servers[index][0].status != 0) {

                ap_mpm_safe_kill((ap_scoreboard_image->parent[index].pid), 10);
                active_children++;
            }
        }
...

        {
            ...
            pidfile = ap_server_root_relative (pconf, ap_pid_fname);
            if ( pidfile != ((void *)0) && unlink(pidfile) == 0)
                ap_log_error("prefork.c",1153, 6,
                                0, ap_server_conf,
                                "removed PID file %s (pid=%ld)",
                                pidfile, (long)getpid());
        }

        ap_log_error("prefork.c",1159, 5, 0, ap_server_conf,
    ...
    apr_signal(10, ((__sighandler_t) 1));
    if (one_process) {
    ...
    if (is_graceful) {
        ap_log_error("prefork.c",1212, 5, 0, ap_server_conf,
        ...
        for (index = 0; index < ap_daemons_limit; ++index) {
            if (ap_scoreboard_image->servers[index][0].status != 0) {
                ap_scoreboard_image->servers[index][0].status = 9;
        ...
        if ((killpg ((getpgrp()), (1))) < 0) {
            ap_log_error("prefork.c",1240, 4, (*__errno_location ()), ap_server_conf, "killpg SIGHUP");
        }
        ap_reclaim_child_processes(0);
        ap_log_error("prefork.c",1243, 5, 0, ap_server_conf,
...
static int prefork_open_logs(apr_pool_t *p, apr_pool_t *plog, apr_pool_t *ptemp, server_rec *s)
{
    ...
    if ((num_listensocks = ap_setup_listeners(ap_server_conf)) < 1) {
        ap_log_error("prefork.c",1261, 1|((0x07 + 1) * 4), 0,
                     ((void *)0), "no listening sockets available, shutting down");
        return -2;
    }

    if ((rv = ap_mpm_pod_open(pconf, &pod))) {
        ap_log_error("prefork.c",1267, 2|((0x07 + 1) * 4), rv, ((void *)0),
    ...
    if (restart_num++ == 1) {
        ...
        if (!one_process && !foreground) {
            rv = apr_proc_detach(no_detach ? 0
                                           : 1);
            if (rv != 0) {
                ap_log_error("prefork.c",1303, 2, rv, ((void *)0),
...
static void prefork_hooks(apr_pool_t *p)
{
    ...
    ap_hook_open_logs(prefork_open_logs, ((void *)0), aszSucc, 10);



    ap_hook_pre_config(prefork_pre_config, ((void *)0), ((void *)0), (-10));
}
...
static const char *set_min_free_servers(cmd_parms *cmd, void *dummy, const char *arg)
{
    ...
    if (ap_daemons_min_free <= 0) {
       ap_log_error("prefork.c",1370, ((0x07 + 1) * 4), 0, ((void *)0),
                    "WARNING: detected MinSpareServers set to non-positive.");
       ap_log_error("prefork.c",1372, ((0x07 + 1) * 4), 0, ((void *)0),
                    "Resetting to 1 to avoid almost certain Apache failure.");
       ap_log_error("prefork.c",1374, ((0x07 + 1) * 4), 0, ((void *)0),
...
static const char *set_max_clients (cmd_parms *cmd, void *dummy, const char *arg)
{
    ...
    if (ap_daemons_limit > server_limit) {
       ap_log_error("prefork.c",1402, ((0x07 + 1) * 4), 0, ((void *)0),
                    "WARNING: MaxClients of %d exceeds ServerLimit value "
                    "of %d servers,", ap_daemons_limit, server_limit);
       ap_log_error("prefork.c",1405, ((0x07 + 1) * 4), 0, ((void *)0),
                    " lowering MaxClients to %d.  To increase, please "
                    "see the ServerLimit", server_limit);
       ap_log_error("prefork.c",1408, ((0x07 + 1) * 4), 0, ((void *)0),
                    " directive.");
       ap_daemons_limit = server_limit;
    }
    else if (ap_daemons_limit < 1) {
        ap_log_error("prefork.c",1413, ((0x07 + 1) * 4), 0, ((void *)0),
...
static const char *set_server_limit (cmd_parms *cmd, void *dummy, const char *arg)
{
    ...
    if (server_limit > 200000) {
       ap_log_error("prefork.c",1445, ((0x07 + 1) * 4), 0, ((void *)0),
                    "WARNING: ServerLimit of %d exceeds compile time limit "
                    "of %d servers,", server_limit, 200000);
       ap_log_error("prefork.c",1448, ((0x07 + 1) * 4), 0, ((void *)0),
                    " lowering ServerLimit to %d.", 200000);
       server_limit = 200000;
    }
    else if (server_limit < 1) {
        ap_log_error("prefork.c",1453, ((0x07 + 1) * 4), 0, ((void *)0),
...
{ "User", { .take1=unixd_set_user }, ((void *)0), 128, TAKE1, "Effective user id for this server" }, { "Group", { .take1=unixd_set_group }, ((void *)0), 128, TAKE1, "Effective group id for this server" }, { "ChrootDir", { .take1=unixd_set_chroot_dir }, ((void *)0), 128, TAKE1, "The directory to chroot(2) into" },
...
{ "StartServers", { .take1=set_daemons_to_start }, ((void *)0), 128, TAKE1, "Number of child processes launched at server startup" }
                                                                     ,
{ "MinSpareServers", { .take1=set_min_free_servers }, ((void *)0), 128, TAKE1, "Minimum number of idle children, to handle request spikes" }
                                                                          ,
{ "MaxSpareServers", { .take1=set_max_free_servers }, ((void *)0), 128, TAKE1, "Maximum number of idle children" }
                                                ,
{ "MaxClients", { .take1=set_max_clients }, ((void *)0), 128, TAKE1, "Maximum number of children alive at the same time" }
                                                                  ,
{ "ServerLimit", { .take1=set_server_limit }, ((void *)0), 128, TAKE1, "Maximum value of MaxClients for this run of Apache" }
                                                                   ,
...
module mpm_prefork_module = {
    20051115, 21, -1, "prefork.c", ((void *)0), ((void *)0), 0x41503232UL,
    ap_mpm_rewrite_args,
    ((void *)0),
    ((void *)0),
    ((void *)0),
