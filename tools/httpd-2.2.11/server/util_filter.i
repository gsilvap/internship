...
# 25 "/usr/include/apr-1/apr_hash.h"
...
# 26 "/usr/include/apr-1/apr_hash.h" 2
                            ...
                            filter_trie_node **reg_filter_set)
{
    ...
    for (n = normalized_name; *n; n++) {
        ...
        if ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*n))))] & (unsigned short int) _ISalpha))) {
            trie_node_link(apr_hook_global_pool, node, child, (toupper(((unsigned char)(*n)))));
        }
        node = child;
    }
    if (node->frec) {
                                          ...
                                          ap_filter_t **c_filters)
{
    ...
    if (frec->ftype < AP_FTYPE_PROTOCOL) {
        if (r) {
            ...
            ap_log_error("util_filter.c",291, 3, 0, ((void *)0),
        ...
        if (r) {
            ...
            ap_log_error("util_filter.c",301, 3, 0, ((void *)0),
                                   ...
                                   ap_filter_t **c_filters)
{
    ...
    ap_log_error("util_filter.c",397, 3, 0, ((void *)0),
