...
# 32 "listen.c" 2
 ...
 ap_listen_rec *ap_listeners = ((void *)0);
...
static apr_status_t make_sock(apr_pool_t *p, ap_listen_rec *server)
{
    ...
    stat = apr_socket_opt_set(s, 16, one);
    if (stat != 0 && stat != ((20000 + 50000) + 23)) {
        ap_log_perror("listen.c",57, 2, stat, p,
    ...
    stat = apr_socket_opt_set(s, 2, one);
    if (stat != 0 && stat != ((20000 + 50000) + 23)) {
        ap_log_perror("listen.c",67, 2, stat, p,
    ...
    if (server->bind_addr->family == 10) {
        stat = apr_socket_opt_set(s, 16384, v6only_setting);
        if (stat != 0 && stat != ((20000 + 50000) + 23)) {
            ap_log_perror("listen.c",78, 2, stat, p,
...
# 107 "listen.c"
    if (send_buffer_size) {
        stat = apr_socket_opt_set(s, 64, send_buffer_size);
        if (stat != 0 && stat != ((20000 + 50000) + 23)) {
            ap_log_perror("listen.c",110, 4, stat, p,
    ...
    if (receive_buffer_size) {
        stat = apr_socket_opt_set(s, 128, receive_buffer_size);
        if (stat != 0 && stat != ((20000 + 50000) + 23)) {
            ap_log_perror("listen.c",120, 4, stat, p,
    ...
    if ((stat = apr_socket_bind(s, server->bind_addr)) != 0) {
        ap_log_perror("listen.c",133, ((0x07 + 1) * 4)|2, stat, p,
    ...
    if ((stat = apr_socket_listen(s, ap_listenbacklog)) != 0) {
        ap_log_perror("listen.c",141, ((0x07 + 1) * 4)|3, stat, p,
                                           ...
                                           server_rec *server)
{
    ...
    if (accf) {
# 228 "listen.c"
        rv = apr_socket_opt_set(s, 32768, 1);
        if (rv != 0 && !((rv) == ((20000 + 50000) + 23))) {
            ap_log_perror("listen.c",230, 4, rv, p,
                                  ...
                                  apr_port_t port, const char* proto)
{
    ...
    if ((status = apr_sockaddr_info_get(&sa, addr, 0, port, 0,
                                        process->pool))
        != 0) {
        ap_log_perror("listen.c",286, 2, status, process->pool,
    ...
    while (sa) {
        ...
        if (status != 0 && !addr &&
            new->bind_addr->family == 10) {
            continue;
        }

        if (status != 0) {
            ap_log_perror("listen.c",324, 2, status, process->pool,
...
# 396 "listen.c"
            if (lr->next != ((void *)0)
                && ((lr->bind_addr)->family == 2 && (lr->bind_addr)->sa.sin.sin_addr.s_addr == ((in_addr_t) 0x00000000))
                && lr->bind_addr->port == lr->next->bind_addr->port
                && ((lr->next->bind_addr)->family == 10 && (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (&(lr->next->bind_addr)->sa.sin6.sin6_addr); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == 0 && __a->__in6_u.__u6_addr32[3] == 0; })))) {
            ...
            if (((lr->bind_addr)->family == 2 && (lr->bind_addr)->sa.sin.sin_addr.s_addr == ((in_addr_t) 0x00000000))) {
                for (cur = ap_listeners; cur != lr; cur = cur->next) {
                    if (lr->bind_addr->port == cur->bind_addr->port
                        && ((cur->bind_addr)->family == 10 && (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (&(cur->bind_addr)->sa.sin6.sin6_addr); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == 0 && __a->__in6_u.__u6_addr32[3] == 0; })))
                        && apr_socket_opt_get(cur->sd, 16384,
                                              &v6only_setting) == 0
                        && v6only_setting == 0) {
            ...
            if (make_sock(pool, lr) == 0) {
                ...
                if (lr->next != ((void *)0)
                    && ((lr->bind_addr)->family == 10 && (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (&(lr->bind_addr)->sa.sin6.sin6_addr); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == 0 && __a->__in6_u.__u6_addr32[3] == 0; })))
                    && lr->bind_addr->port == lr->next->bind_addr->port
                    && ((lr->next->bind_addr)->family == 2 && (lr->next->bind_addr)->sa.sin.sin_addr.s_addr == ((in_addr_t) 0x00000000))) {
    ...
    for (lr = ap_listeners; lr; lr = lr->next) {
        ...
        status = apr_socket_opt_set(lr->sd, 8, use_nonblock);
        if (status != 0) {
            ap_log_perror("listen.c",502, ((0x07 + 1) * 4)|3, status, pool,
    ...
    if (!data) {
        ...
        apr_pool_cleanup_register(pool, ((void *)0), apr_pool_cleanup_null,
