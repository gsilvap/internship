...
# 50 "/usr/include/apr-1/apr_md5.h"
# 1 "/usr/include/apr-1/apu.h" 1
# 51 "/usr/include/apr-1/apr_md5.h" 2
...
# 24 "main.c" 2
# 1 "/usr/include/apr-1/apr_version.h" 1
# 140 "/usr/include/apr-1/apr_version.h"
typedef struct {
    int major;
    int minor;
    int patch;
...
# 25 "main.c" 2
# 1 "/usr/include/apr-1/apu_version.h" 1
# 114 "/usr/include/apr-1/apu_version.h"
# 1 "/usr/include/apr-1/apr_version.h" 1
# 115 "/usr/include/apr-1/apu_version.h" 2
# 128 "/usr/include/apr-1/apu_version.h"
...
# 122 "main.c"
    printf(" -D APACHE_MPM_DIR=\"" "server/mpm/prefork" "\"\n");
# 134 "main.c"
...
# 221 "main.c"
    printf(" -D HTTPD_ROOT=\"" "/home/user/Desktop/demo/installdir/" "\"\n");



    printf(" -D SUEXEC_BIN=\"" "/home/user/Desktop/demo/installdir/" "/bin/suexec" "\"\n");
    ...
    printf(" -D DEFAULT_LOCKFILE=\"" "logs" "/accept.lock" "\"\n");
...
static void usage(process_rec *process)
{
    ...
    ap_log_error("main.c",338, ((0x07 + 1) * 4), 0, ((void *)0),
                 "Usage: %s [-D name] [-d directory] [-f file]", bin);


    ap_log_error("main.c",342, ((0x07 + 1) * 4), 0, ((void *)0),
                 "       %s [-C \"directive\"] [-c \"directive\"]", pad);
# 354 "main.c"
    ap_log_error("main.c",354, ((0x07 + 1) * 4), 0, ((void *)0),
    ...
    ap_log_error("main.c",363, ((0x07 + 1) * 4), 0, ((void *)0),
                 "       %s [-v] [-V] [-h] [-l] [-L] [-t] [-S]", pad);
    ap_log_error("main.c",365, ((0x07 + 1) * 4), 0, ((void *)0),
                 "Options:");
    ...
    ap_log_error("main.c",374, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -D name            : define a name for use in "
                 "<IfDefine name> directives");
    ap_log_error("main.c",377, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -d directory       : specify an alternate initial "
                 "ServerRoot");
    ap_log_error("main.c",380, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -f file            : specify an alternate ServerConfigFile");
    ap_log_error("main.c",382, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -C \"directive\"     : process directive before reading "
                 "config files");
    ap_log_error("main.c",385, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -c \"directive\"     : process directive after reading "
                 "config files");
# 415 "main.c"
    ap_log_error("main.c",415, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -e level           : show startup errors of level "
                 "(see LogLevel)");
    ap_log_error("main.c",418, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -E file            : log startup errors to file");
    ap_log_error("main.c",420, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -v                 : show version number");
    ap_log_error("main.c",422, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -V                 : show compile settings");
    ap_log_error("main.c",424, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -h                 : list available command line options "
                 "(this page)");
    ap_log_error("main.c",427, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -l                 : list compiled in modules");
    ap_log_error("main.c",429, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -L                 : list available configuration "
                 "directives");
    ap_log_error("main.c",432, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -t -D DUMP_VHOSTS  : show parsed settings (currently only "
                 "vhost settings)");
    ap_log_error("main.c",435, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -S                 : a synonym for -t -D DUMP_VHOSTS");
    ap_log_error("main.c",437, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -t -D DUMP_MODULES : show all loaded modules ");
    ap_log_error("main.c",439, ((0x07 + 1) * 4), 0, ((void *)0),
                 "  -M                 : a synonym for -t -D DUMP_MODULES");
    ap_log_error("main.c",441, ((0x07 + 1) * 4), 0, ((void *)0),
...
int main(int argc, const char * const argv[])
{
    ...
    const char *def_server_root = "/home/user/Desktop/demo/installdir/";
    ...
    apr_pool_create_ex(&pcommands, pglobal, ((void *)0), ((void *)0));
    ...
    if (error) {
        ap_log_error("main.c",489, ((0x07 + 1) * 4)|0, 0, ((void *)0), "%s: %s",
    ...
    while ((rv = apr_getopt(opt, "C:c:D:d:E:e:f:vVlLtSMh?X", &c, &optarg))
            == 0) {
        char **new;
    ...
    apr_pool_create_ex(&plog, pglobal, ((void *)0), ((void *)0));
    ...
    if (ap_run_pre_config(pconf, plog, ptemp) != 0) {
        ap_log_error("main.c",639, ((0x07 + 1) * 4) |3, 0,
                     ((void *)0), "Pre-configuration failed");
        destroy_and_exit_process(process, 1);
    }
    ...
    if (rv == 0) {
        ...
        if (configtestonly) {
            ...
            ap_log_error("main.c",653, ((0x07 + 1) * 4), 0, ((void *)0), "Syntax OK");
            destroy_and_exit_process(process, 0);
        }
    }
    ...
    if ( ap_run_open_logs(pconf, plog, ptemp, server_conf) != 0) {
        ap_log_error("main.c",675, ((0x07 + 1) * 4) |3,
                     0, ((void *)0), "Unable to open logs");
        destroy_and_exit_process(process, 1);
    }

    if ( ap_run_post_config(pconf, plog, ptemp, server_conf) != 0) {
        ap_log_error("main.c",681, ((0x07 + 1) * 4) |3, 0,
                     ((void *)0), "Configuration Failed");
        destroy_and_exit_process(process, 1);
    }
    ...
    for (;;) {
        ...
        if (ap_run_pre_config(pconf, plog, ptemp) != 0) {
            ap_log_error("main.c",710, ((0x07 + 1) * 4) |3,
                         0, ((void *)0), "Pre-configuration failed");
            destroy_and_exit_process(process, 1);
        }
        ...
        apr_pool_clear(plog);
        if (ap_run_open_logs(pconf, plog, ptemp, server_conf) != 0) {
            ap_log_error("main.c",724, ((0x07 + 1) * 4) |3,
                         0, ((void *)0), "Unable to open logs");
            destroy_and_exit_process(process, 1);
        }

        if (ap_run_post_config(pconf, plog, ptemp, server_conf) != 0) {
            ap_log_error("main.c",730, ((0x07 + 1) * 4) |3,
                         0, ((void *)0), "Configuration Failed");
            destroy_and_exit_process(process, 1);
        }
