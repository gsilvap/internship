...
# 1 "util_xml.c"
# 17 "util_xml.c"
# 1 "/usr/include/apr-1/apr_xml.h" 1
# 28 "/usr/include/apr-1/apr_xml.h"
...
# 29 "/usr/include/apr-1/apr_xml.h" 2
...
# 30 "/usr/include/apr-1/apr_xml.h" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 31 "/usr/include/apr-1/apr_xml.h" 2

# 1 "/usr/include/apr-1/apu.h" 1
# 33 "/usr/include/apr-1/apr_xml.h" 2
# 50 "/usr/include/apr-1/apr_xml.h"
...
void apr_text_append(apr_pool_t *p, apr_text_header *hdr,
                                  const char *text);
# 141 "/usr/include/apr-1/apr_xml.h"
...
# 333 "/usr/include/apr-1/apr_xml.h"
...
# 25 "util_xml.c" 2
# 1 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_xml.h" 1
# 44 "/run/media/master/data/OneDrive/mei/internship/tools/httpd-2.2.11/include/util_xml.h"
...
int ap_xml_parse_input(request_rec * r, apr_xml_doc **pdoc)
{
    ...
    do {
        ...
        for (bucket = (&(brigade)->list)->next;
             bucket != (struct apr_bucket *)((char *)(&(&(brigade)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))));
             bucket = ((bucket))->link.next)
        {
            ...
            status = (bucket)->type->read(bucket, &data, &len, APR_BLOCK_READ);
            if (status != 0) {
                goto read_error;
            }
            ...
            if (limit_xml_body && total_read > limit_xml_body) {
                ap_log_rerror("util_xml.c",84, 3, 0, r,
    ...
    if (status) {
        ...
        ap_log_rerror("util_xml.c",110, 3, 0, r,
  ...
  parser_error:
    ...
    ap_log_rerror("util_xml.c",122, 3, 0, r,
  ...
  read_error:
    ...
    (void) apr_xml_parser_done(parser, ((void *)0));
