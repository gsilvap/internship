...
static struct { apr_array_header_t *link_post_read_request; apr_array_header_t *link_log_transaction; apr_array_header_t *link_http_scheme; apr_array_header_t *link_default_port; } _hooks;
...
request_rec *ap_read_request(conn_rec *conn)
{
    ...
    if (!read_request_line(r, tmp_bb)) {
        if (r->status == 414) {
            ap_log_rerror("protocol.c",893, 3, 0, r,
    ...
    csd = (((void **)(conn->conn_config))[(&core_module)->module_index]);
    ...
    if (!r->assbackwards) {
        ap_get_mime_headers_core(r, tmp_bb);
        if (r->status != 408) {
            ap_log_rerror("protocol.c",920, 3, 0, r,
        ...
        if (r->header_only) {
            ...
            ap_log_rerror("protocol.c",945, 3, 0, r,
    ...
    if ((!r->hostname && (r->proto_num >= (1000*(1)+(1))))
        ...
        r->status = 400;
        ap_log_rerror("protocol.c",989, 3, 0, r,
...
# 1001 "protocol.c"
    ...
    if (((expect = apr_table_get(r->headers_in, "Expect")) != ((void *)0))
        ...
        if (strcasecmp(expect, "100-continue") == 0) {
            ...
            r->status = 417;
            ap_log_rerror("protocol.c",1031, 6, 0, r,
...
void ap_note_auth_failure(request_rec *r)
{
    ...
    if (type) {
        ...
        ap_log_rerror("protocol.c",1156, 3,
...
int ap_get_basic_auth_pw(request_rec *r, const char **pw)
{
    ...
    if (!ap_auth_name(r)) {
        ap_log_rerror("protocol.c",1200, 3,
    ...
    if (strcasecmp(ap_getword(r->pool, &auth_line, ' '), "Basic")) {
        ...
        ap_log_rerror("protocol.c",1212, 3, 0, r,
    ...
    while (e != (struct apr_bucket *)((char *)(&(&(b)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void *)0))->link))) - ((char *) ((void *)0)))))) {
        ...
        if (e->length == (apr_size_t)-1) {
            ...
            if (rv == 0) {
                ...
                ap_log_rerror("protocol.c",1303, 3, rv, r,
...
int ap_rputs(const char *str, request_rec *r)
{
    ...
    if (buffer_output(r, str, len = strlen(str)) != 0)
        return -1;
...
void ap_send_interim_response(request_rec *r, int send_headers)
{
    ...
    if (!(((r->status) >= 100)&&((r->status) < 200))) {
        ap_log_rerror("protocol.c",1652, 7, 0, ((void *)0),
    ...
    ap_fputstrs(x.f, x.bb, "HTTP/1.1", " ", r->status_line, "\015\012", ((void *)0));
    if (send_headers) {
        apr_table_do(send_header, &x, r->headers_out, ((void *)0));
        apr_table_clear(r->headers_out);
    }
    apr_brigade_puts(x.bb, ap_filter_flush, x.f, "\015\012");
    ap_fflush(x.f, x.bb);
